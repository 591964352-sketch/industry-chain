...
| 类型 | 审批 |
|---|---|
| 数据字段更新 / 豆包数据写入 / 文字修改 / bug 修复 / 文档模板更新 | ✅ **直接 commit**（page_audit 14/14 PASS 后）|
...
```bash
python scripts/page_audit.py → 14/14 PASS
```
...
1. **跑 page_audit**：`python scripts/page_audit.py` → 14/14 应通过
