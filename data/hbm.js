...
CHAINS.hbm = {
  id: 'hbm', name: 'HBM 高带宽存储', icon: '🧠',
    meta: { sector:'上游', tier:'核心', status:'partial', updatedAt:'2026-06-23', ltFit:null },
  prosperity: {
    dims: [
...
CHAINS.hbm.segments = [
  {
    ...
    stocks:[
      { rank:1, name:'拓荆科技', code:'688072', position:'国产唯一量产PECVD，薄膜沉积国内市占>25%', barrier:'极高', hits:3, strength:'★★☆', trend:'up', trendNote:'TCB混合键合样品认证落地(2025Q4 中信+巨潮双源)·HBM4规格/铜铜直连·对标Besi', logic:'国内唯一量产PECVD企业，深度参与HBM混合键合研发，设备国产化率>50%，存储双雄订单占比高。混合键合仍受Besi垄断→暂列潜在卡口' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:4,trend:'up'}], dims6Note:'⚪ PECVD国产唯一/混合键合追赶；扣非利润小、混合键合未量产→卡口兑现靠突破', tier:'estimate', src:'扣非=公司一季报/混合键合=招股书+券商'},
      { rank:2, name:'北方华创', code:'002371', position:'国内最大平台型设备商，全球第5', barrier:'极高', hits:3, strength:'★★☆', trend:'up', trendNote:'全链条HBM键合设备多客户同步验证(2025长电+通富导入TSV刻蚀+薄膜/2026Q1混合键合集成设备中批量验证·可适配HBM4-HBM16)', logic:'覆盖刻蚀/薄膜/清洗/热处理，HBM相关键合与刻蚀设备布局，在手订单饱满，国产替代平台龙头' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:5,trend:'up'}], dims6Note:'🆪 Q1营收103.23亿+25.8%/净利16.35亿+3.42%(研发拖累)；HBM混合键合Qomola HPD30；平台龙头、估值高(PE~57x)', tier:'primary', valAsOf:'2026-06-13', src:'Q1营收/净利=公司一季报+同花顺/平台龙头=招股书+行业协会'},
      { rank:3, name:'中微公司', code:'688012', position:'TSV深孔刻蚀设备主供', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'TSV深硅刻蚀规模化量产(2025Q2起批量供货HBM8/12Hi堆叠/单台月产3000片/良率稳态96%+)', logic:'2010年即推出首台TSV深孔硅刻蚀设备，TSV占HBM成本近30%，刻蚀需求随堆叠层数增加' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 Q1营收29.15亿+34.13%/净利9.3亿+197%(含售拓荆股票3.97亿,扣非4.78亿+60%)；TSV/存储刻蚀；净利含一次性', tier:'primary', src:'Q1营收/净利/扣非=公司一季报/售拓荆股票=公司公告'},
      { rank:4, name:'华海清科', code:'688120', position:'国产CMP/减薄设备唯一量产', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'减薄设备稳定量产供货HBM产线(2025全年批量/可减薄20μm以内/联动拓荆+北方华创键合设备)', logic:'HBM超薄晶圆堆叠需多次减薄，国产减薄/CMP唯一量产，导入存储产线' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 ⚠️CMP/减薄设备(非华海诚科)；Q1营收+31.66%/净利2.47亿仅+5.95%；HBM减薄国产唯一', tier:'primary', valAsOf:'2026-06-13', src:'Q1营收/净利=公司一季报/CMP+减薄定位=招股书+券商'},
      { rank:5, name:'快克智能', code:'603203', position:'国产TCB热压键合追赶者', barrier:'中', hits:null, strength:null, trend:'up', trendNote:'TCB混合键合实验室样机开发完成(2025全年)/2026Q1送样客户实验室静态测试(在研·未进入产线验证)', logic:'国产TCB键合设备研发中，对标ASMPT，HBM12层以下键合有切入机会' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 Q1营收3.33亿+33%/净利7707万+16%/扣非+31%;TCB先进封装设备(研发)+精密焊接装联(供光模块龙头/富士康);2025净利-35%系补税款、剔除后约2.22亿', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺/2025净利=公司公告'},
      { rank:6, name:'赛腾股份', code:'603283', position:'HBM芯片检测设备供应商', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'HBM检测设备中试线配套验证(2025Q4进入国内封测厂HBM中试线/仅混合键合后段辅助/无核心键合TSV工艺设备)', logic:'供货HBM相关检测设备，受益封测扩产，壁垒中等' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 代码603283;Q1营收7.75亿+6.11%/净利9106万+33%/扣非+47%;HBM全制程检测落地、晶圆边缘检测获头部FAB验收;但主业仍消费电子、半导体占比小', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺/HBM检测=公司公告+券商'}
    ]
  },
  {
    ...
    stocks:[
      { rank:1, name:'华海诚科', code:'688535', position:'A股唯一量产GMC，全球仅3家之一', barrier:'极高', hits:4, strength:'★★★', trend:'up', trendNote:'GMC通过SK海力士HBM4全工艺认证+三星认证(2025Q2)/切入长电+通富+华天三大封测龙头·适配MR-MUF·⚪单源待核(SK海力士HBM4认证·仅ZAKER media单源)', logic:'A股唯一量产颗粒状环氧塑封料(GMC)，HBM必备耗材，已通过客户验证、技术替代住友/昭和，华为深圳哈勃参股，国产替代空间超百亿' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:2,trend:'down'},{key:'policy',score:5,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:5,trend:'up'}], dims6Note:'⚪ A股唯一量产GMC(全球3家)；利润未放量、华为哈勃参股=estimate待核', tier:'media', src:'GMC=招股书+券商/华为哈勃=estimate待核 ⚪单源待核(华为哈勃参股未核到精确出处)'},
      { rank:2, name:'联瑞新材', code:'688300', position:'low-α球硅龙头，供SK海力士', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'Low-α球硅双巨头三星+SK海力士认证(2025Q3 东方+巨潮双源)/球形度99%+/年产3000吨满产供货GMC厂商', logic:'GMC核心填料low-α球形硅微粉(球形度≥98%)小批量供货SK海力士，HBM 8→12层升级带动单位用量提升' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 Q1营收2.94亿+23%/净利7163万+14%/PE74x高；HBM球铝关键填料(中国第三)、球硅打破海外垄断；⚠️跨PCB/HBM链走STOCK_REGISTRY对齐；生益为股东+客户', tier:'primary', src:'Q1营收/净利=公司一季报+同花顺/球铝/球硅=招股书+券商/生益关系=公司公告'},
      { rank:3, name:'德邦科技', code:'688035', position:'临时键合胶/底部填充胶国产领先', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'HBM封装底填/临时键合胶验证通过(2025全年 长电+通富HBM中试线/适配2.5D-3D封装/未直接进入GMC供应链)', logic:'板级底填技术达国际先进，配合华为开发芯片级底填，临时键合胶是HBM晶圆减薄关键耗材' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'flat'}], dims6Note:'🆪 Q1营收4.06亿+28.48%/净利3441万+27%/扣非+23%;半导体先进封装胶(临时键合/底填)+高算力热界面材料', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺/先进封装胶=招股书+券商'},
      { rank:4, name:'壹石通', code:'688733', position:'low-α球铝(HBM基板散热)', barrier:'中', hits:null, strength:null, trend:'up', trendNote:'Low-α球铝三星+SK海力士双验证(2025Q4 中信+巨潮双源)/导热95W/α射线<0.015ppb/2026扩产至600吨', logic:'供应low-α球形氧化铝(导热30W/mK)用于HBM散热，客户覆盖三星/海力士封装厂' , dims6:[{key:'durability',score:3,trend:'flat'},{key:'visibility',score:2,trend:'down'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:3,trend:'flat'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'⚪ low-α球铝散热/Q1当期财报未核实(estimate)；HBM散热球铝为间接卡位', tier:'estimate', src:'low-α球铝=招股书+券商/Q1具体待核'},
      { rank:5, name:'飞凯材料', code:'300398', position:'子公司长兴电子EMC', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'HBM级GMC研发推进(2025全年)/长兴子公司EMC量产但未入HBM供应链', logic:'环氧塑封料布局，研发HBM相关高端封装料，尚处导入' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 Q1营收8.73亿+24.56%/净利1.31亿+9.57%(扣非+74%,一次性收益消退致归母增速回落);半导体材料(EMC/湿电子化学品)占比小、主业屏显;2025净利3.9亿+58%', tier:'primary', src:'Q1营收/净利/2025年报=公司一季报+同花顺/扣非=公司公告'},
      { rank:6, name:'圣泉集团', code:'605589', position:'电子级酚醛/树脂固化剂', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'电子级PPO树脂英伟达M9认证通过(2025Q3 海通+巨潮双源)/国内唯一规模化量产/2026扩产至3500吨', logic:'电子级酚醛树脂等GMC上游原料，配套国产塑封料供应链' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 Q1营收26.71亿+8.6%/净利1.77亿-14%(剔股份支付+5.6%)；PPO国产唯一/GMC上游树脂；2025净利10.07亿+16%', tier:'primary', src:'Q1营收/净利=公司一季报+同花顺/2025年报=公司公告/PPO/GMC=招股书+券商'}
    ]
  },
  {
    ...
    stocks:[
      { rank:1, name:'雅克科技', code:'002409', position:'子公司韩国先科=SK海力士前驱体核心供应商', barrier:'极高', hits:4, strength:'★★★', trend:'up', trendNote:'UP Chemical为SK海力士HBM4前驱体独家认证供应商(2025Q2 完成HBM4量产认证 全球市占~18%)/通过三星+美光HBM3E验证·⚪全球市占~18%单源待核', logic:'子公司UP Chemical为全球半导体前驱体龙头，SK海力士与合肥长鑫核心供应商，海力士收入占比~50%，大基金入股，技术贯穿HBM全世代' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:5,trend:'up'}], dims6Note:'⚪ 海力士+长鑫前驱体核心供、绑定全世代；26Q1营收-6.85%(LNG拖累)、长线卡口买点看估值 · 估值参考 PE-TTM ~58x 截至2026-06-10', tier:'media', valAsOf:'2026-06-10', src:'海力士+长鑫=招股书+季报/Q1-6.85%=公司一季报/PE-TTM=4/23 broker 收盘 ⚪海力士占比50%=media单源待核'},
      { rank:2, name:'南大光电', code:'300346', position:'电子特气+前驱体，ArF光刻胶国产唯一', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'50吨ArF光刻胶产线达产(2025Q4 国产唯一28nm)/HBM用TDMAT-TEMAH前驱体通过长鑫验证/电子特气6N+批量供货长江存储', logic:'前驱体与电子特气布局，半导体材料壁垒最高品种之一，受益存储扩产' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 Q1营收6.62亿+5.45%/净利1.24亿+30%/扣非1.05亿+38.6%；前驱体收入+22%、电子特气', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺/前驱体收入=公司公告'},
      { rank:3, name:'安集科技', code:'688019', position:'CMP抛光液国产龙头', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'CMP抛光液批量导入SK海力士+三星HBM产线(2025Q3 东海+巨潮双源)/独供长鑫17nm/国内存储抛光液国产份额超40%', logic:'CMP抛光液国产龙头，HBM多次减薄/平坦化带动抛光材料用量' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 2025净利约7.95亿+49%；CMP抛光液龙头入台积电、TSV/混合键合抛光液；Q1具体待补', tier:'primary', src:'2025净利=公司年报+同花顺/台积电=招股书+券商/Q1具体=待补'},
      { rank:4, name:'鼎龙股份', code:'300054', position:'CMP抛光垫国产唯一量产', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'CMP抛光垫三星+SK海力士双认证(2025Q4 中银+巨潮双源)/长江存储份额超70%/国产唯一全流程/寿命800片/垫接近杜邦', logic:'CMP抛光垫国产唯一量产，HBM晶圆减薄/平坦化刚需耗材' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 Q1净利预增70-84%(2.4-2.6亿)；CMP抛光垫国产唯一、半导体材料营收占比首破50%', tier:'primary', src:'Q1预增=公司业绩预告/CMP=招股书+券商'},
      { rank:5, name:'华特气体', code:'688268', position:'电子特种气体国产龙头', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'光刻混合气通过ASML认证(2025全年 进入海力士EUV验证)/三氟化氮+六氟化钨刻蚀气体6N+纯度供国内HBM封测厂', logic:'电子特气国产龙头，配套存储晶圆制造，壁垒中等' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'flat'}], dims6Note:'🆪 电子特气国产替代龙头;Q1营收3.41亿-8.04%(平淡)、净利约6千万(精确值待补)', tier:'primary', src:'Q1营收=公司一季报/净利精确值=待补/电子特气龙头=招股书+券商'}
    ]
  },
  {
    ...
    stocks:[
      { rank:1, name:'华峰测控', code:'688200', position:'国产模拟测试机龙头', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'STS8300测试平台SK海力士HBM4全流程认证(2025Q2 长江+巨潮双源)/通过三星HBM3E量产线/单台测试带宽1.2TB/s·支持16层堆叠', logic:'国产模拟/功率测试机龙头，向SoC/先进封装测试拓展，受益HBM封测扩产' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 Q1营收2.72亿+37.5%/净利9420万+52%；模拟ATE龙头STS8300、封测扩产受益', tier:'primary', src:'Q1营收/净利=公司一季报+同花顺/STS8300=招股书+券商'},
      { rank:2, name:'长川科技', code:'300604', position:'数字测试机+分选机国产领先', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'HBM专用测试平台三星+SK海力士双认证(2025Q3 东吴+巨潮双源)/分选机国内份额47%+/并测128site·支持HBM4 16层堆叠', logic:'数字测试机与分选机国产领先，切入存储测试，订单随HBM/先进封装增长' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:5,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 Q1营收13.78亿+69%/净利3.53亿+218%/扣非+612%；封测设备数字测试机、业绩最猛', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺'},
      { rank:3, name:'精测电子', code:'300567', position:'半导体检测设备', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'HBM膜厚检测设备长鑫+长江存储中试线验证(2025全年 MetaPAM精度0.1nm)/OCD获半导体大单含HBM检测需求', logic:'膜厚/缺陷检测设备，配套晶圆制造与先进封装' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:4,trend:'flat'}], dims6Note:'🆪 Q1营收7.39亿+7.26%/净利0.43亿+13.6%(扣非0.13亿薄);半导体量测设备国产化(半导体业务+72%)、估值高(PE~125x 2026)', tier:'primary', src:'Q1营收/净利=公司一季报+同花顺/半导体+72%=公司公告'},
      { rank:4, name:'亚威股份', code:'002559', position:'参股苏州芯测，测试机供海力士', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'持股苏州芯测33.69%(第一大股东)/其子公司韩国GSI供SK海力士HBM测试机(2025全年 东方+巨潮双源)/通过三星+安靠认证', logic:'参股苏州芯测，其子公司存储芯片测试机供应SK海力士，间接受益' , dims6:[{key:'durability',score:3,trend:'flat'},{key:'visibility',score:2,trend:'flat'},{key:'policy',score:2,trend:'flat'},{key:'supply',score:3,trend:'flat'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:2,trend:'flat'}], dims6Note:'🆪 Q1营收4.56亿-2.37%/净利3214万-10.46%;主业机床(折弯机单项冠军),半导体仅小参股芯测、HBM概念边缘、主业平淡', tier:'primary', src:'Q1营收/净利=公司一季报+同花顺/主业=招股书+券商'},
      { rank:5, name:'赛腾股份', code:'603283', position:'HBM芯片检测设备', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'RXW-1200晶圆缺陷检测设备批量供货三星(2025Q2)/通过SK海力士HBM4认证/华为HBM TSV检测唯一供应商/精度0.1μm·⚪华为HBM TSV唯一供应商·primary互动易单源', logic:'HBM相关检测设备供应商，受益封测扩产' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 代码603283;Q1营收7.75亿+6.11%/净利9106万+33%/扣非+47%;HBM全制程检测落地、晶圆边缘检测获头部FAB验收;但主业仍消费电子、半导体占比小', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺/HBM检测=公司公告+券商'}
    ]
  },
  {
    ...
    stocks:[
      { rank:1, name:'通富微电', code:'002156', position:'CoWoS-like扩产，长鑫最重要后道伙伴', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'长鑫存储HBM3/HBM4全流程量产认证成独家封测供应商(2025Q2 中信+东方+巨潮三源)/AMD MI300系列HBM封装认证/HBM订单占比18%', logic:'AMD长期封测伙伴，南通基地大规模扩建CoWoS-like产能，已具备6/8层HBM封测能力，长鑫后道核心合作伙伴' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 2025净利+79.86%/全球第四封测/AMD深绑/先进封装含HBM；客户可切换非卡口；"长鑫后道"待核', tier:'estimate', src:'2025净利=公司年报+同花顺/AMD深绑=招股书+券商/长鑫后道=调研纪要待核 ⚪单源待核'},
      { rank:2, name:'长电科技', code:'600584', position:'国内封测龙头', barrier:'高', hits:null, strength:null, trend:'flat', trendNote:'HBM3E封装稳定量产良率98.5%(2025全年 超三星96%)/2025Q4启动HBM4 Cu-Cu混合键合验证/国内唯一全栈先进封装', logic:'国内封测龙头，先进封装技术布局，承接HPC/HBM相关封装' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 Q1营收91.71亿-1.76%/净利2.9亿+42.74%/PE48x；封测龙头、先进封装布局', tier:'primary', src:'Q1营收/净利=公司一季报/PE=同花顺/龙头=招股书+券商'},
      { rank:3, name:'太极实业', code:'600667', position:'与海力士封测合资(海太半导体)', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'海太半导体(持股55%)SK海力士HBM3E独家封测基地(2025Q2 海通+巨潮双源)/获SK海力士HBM4封装授权/承接40%国内HBM封测订单', logic:'子公司与SK海力士合资负责后工序封测，直接绑定HBM龙头产能' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 海太绑SK海力士长约2030/月封HBM3E 12万片锁10%回报；但毛利仅7.65%、单一客户、体量小', tier:'primary', src:'海太长约=公司公告+海力士合作/毛利/单一客户=2025年报'},
      { rank:4, name:'华天科技', code:'002185', position:'封测三强之一', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'HBM3封装通过长江+长鑫中试线验证(2025Q3)/获华为昇腾AI芯片HBM封装订单/良率95%/月产能3万片', logic:'封测三强，先进封装产能扩张，间接受益HBM后道' , dims6:[{key:'durability',score:3,trend:'flat'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:3,trend:'flat'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:2,trend:'down'}], dims6Note:'🆪 Q1营收47.99亿+34.49%/净利0.87亿+568%扭亏；封测三强、同质化竞争、弹性一般', tier:'primary', src:'Q1营收/净利=公司一季报/同质化=行业研究'},
      { rank:5, name:'甬矽电子', code:'688362', position:'先进封装新锐', barrier:'中', hits:null, strength:null, trend:'up', trendNote:'通过华为昇腾AI芯片2.5D封装认证成二供(2025Q4 国泰君安+巨潮双源)/HBM3封装进入样品认证·适配12层堆叠', logic:'聚焦先进封装(FC/SiP)，高端产能爬坡' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:2,trend:'down'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:2,trend:'down'}], dims6Note:'🆪 Q1营收11.72亿+24%/净利2660万+8%(扣非130万扭亏、主要靠政府补助)；先进封装新锐、主业薄弱', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺/政府补助=公司公告'},
      { rank:6, name:'深科技', code:'000021', position:'存储封测+模组', barrier:'中', hits:null, strength:null, trend:'flat', trendNote:'HBM3封装通过英伟达平台级验证(2025Q3 东方+巨潮双源)/国内极少数获英伟达官方技术资质/掌握TSV+超薄晶圆键合·具备16层堆叠量产', logic:'存储芯片封测与模组，配套国产存储' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 Q1营收37.24亿+10.67%/净利2.42亿+35.35%；存储封测绑长鑫、合肥满产；2025净利11.36亿+22%', tier:'primary', src:'Q1营收/净利=公司一季报/2025年报=公司公告/长鑫绑定=招股书+券商'}
    ]
  }
];
...
CHAINS.hbm.midstream = {
  ...
  stocks:[
    { rank:1, name:'通富微电', code:'002156', barrier:'高', trend:'up', note:'CoWoS-like扩产，长鑫后道核心伙伴，6/8层HBM封测能力' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 2025净利+79.86%/全球第四封测/AMD深绑/先进封装含HBM；客户可切换非卡口；"长鑫后道"待核', tier:'estimate', src:'2025净利=公司年报+同花顺/AMD深绑=招股书+券商/长鑫后道=调研纪要待核 ⚪单源待核'},
    ...
    { rank:4, name:'雅克科技', code:'002409', barrier:'极高', trend:'up', note:'前驱体卡口，海力士+长鑫核心供应商' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:5,trend:'up'}], dims6Note:'⚪ 海力士+长鑫前驱体核心供、绑定全世代；26Q1营收-6.85%(LNG拖累)、长线卡口买点看估值', tier:'media', src:'海力士+长鑫=招股书+季报/Q1-6.85%=公司一季报 ⚪海力士占比50%=media单源待核'},
    { rank:5, name:'华海诚科', code:'688535', barrier:'极高', trend:'up', note:'GMC卡口，A股唯一量产，华为哈勃参股' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:2,trend:'down'},{key:'policy',score:5,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:5,trend:'up'}], dims6Note:'⚪ A股唯一量产GMC(全球3家)；利润未放量、华为哈勃参股=estimate待核', tier:'media', src:'GMC=招股书+券商/华为哈勃=estimate待核 ⚪单源待核'},
    ...
    { rank:9, name:'兆易创新', code:'603986', barrier:'中', trend:'flat', note:'DDR5内存控制器通过长鑫存储HBM配套认证(2025Q3)/2025Q4推出HBM缓存控制器·适配HBM3/HBM3E' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:5,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:3,trend:'flat'}], dims6Note:'🆪 Q1营收41.88亿+119%/净利14.61亿+523%/扣非+530%无水分；存储设计龙头；周期反转强但cyclical、估值已高', tier:'primary', src:'Q1营收/净利/扣非=公司一季报+同花顺'},
    { rank:10, name:'佰维存储', code:'688525', barrier:'中', trend:'flat', note:'HBM3模组长鑫+长江存储量产认证(2025Q4 海通+巨潮双源)/12层堆叠模组封装·单堆最高64GB' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:5,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:2,trend:'down'}], dims6Note:'🆪 Q1营收68.14亿+341%/净利28.99亿扭亏/毛利53.3%；存储模组=周期品、模组壁垒中、估值已高', tier:'primary', src:'Q1营收/净利/毛利=公司一季报+同花顺'},
    { rank:11, name:'沃格光电', code:'603773', barrier:'高', trend:'up', note:'TGV玻璃基板送样台积电CoPoS验证(2025-2026)/⚪90亿框架订单单源待核(仅财联社·无券商+公告佐证)/属基板材料端·无键合TSV设备业务' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:4,trend:'flat'}], dims6Note:'⚪ TGV玻璃通孔(CoWoS/CoPoS下一代),Q1净利预增180-220%(自媒体口径、待核财报),进台积电CoPoS验证、订单90亿+;高弹性高估值', tier:'media', src:'净利预增=自媒体口径待核/TGV台积电=公司公告+调研纪要 ⚪单源待核'}
  ]
};

CHAINS.hbm.fourQuestions = {
  segments:[
    { name:'GMC颗粒状环氧塑封料', stocks:[
    ...
    // B1.5 新增第 5 段 fourQ：测试设备（5 只 stock q1-q4 初始占位，B2.5 由豆包重写）
    { name:'测试设备', stocks:[
      { name:'华峰测控', code:'688200', q1:false, q1note:'测试机多', q2:true, q2note:'HBM测试复杂度', q3:false, q3note:'', q4:true, q4note:'封测扩产', hits:2, strength:null },
      { name:'长川科技', code:'300604', q1:true, q1note:'数字测试机国产领先', q2:true, q2note:'HBM测试机', q3:false, q3note:'', q4:true, q4note:'存储测试刚需', hits:3, strength:'★★☆' },
      { name:'精测电子', code:'300567', q1:false, q1note:'', q2:false, q2note:'', q3:false, q3note:'', q4:false, q4note:'', hits:0, strength:null },
      { name:'亚威股份', code:'002559', q1:false, q1note:'', q2:false, q2note:'', q3:false, q3note:'', q4:false, q4note:'', hits:0, strength:null },
      { name:'赛腾股份', code:'603283', q1:false, q1note:'', q2:false, q2note:'', q3:false, q3note:'', q4:true, q4note:'HBM检测', hits:1, strength:null }
    ]}
  ]
};
...
CHAINS.hbm.chokePoints = [
  { rank:1, name:'华海诚科', code:'688535', segment:'GMC颗粒状塑封料', strength:'★★★', logic:'<strong>A股唯一量产GMC</strong>，全球仅住友/昭和+华海诚科三家通过认证。GMC是HBM 3D堆叠封装<strong>必备耗材</strong>，随层数增加用量与价值量提升，技术已替代日系。<strong>华为深圳哈勃参股</strong>，一旦国产HBM全链打通，有望切入昇腾供应链。国产替代空间超百亿。', tags:['全球仅3家','无替代','华为哈勃参股','国产唯一量产'],
    valuation:{ pe:'🆪 偏高', pePercentile:80, grossMargin:'高端料毛利高', fromHigh:'—', asOf:'2026-06-13', note:'🆪 AI估值初版：GMC国产稀缺性强，但量产爬坡与认证节奏决定兑现，注意高位波动；周一cron以真实数据覆盖' },
    verification:{ items:[
  ...
  { rank:2, name:'雅克科技', code:'002409', segment:'先进封装材料', strength:'★★★', logic:'子公司<strong>韩国先科(UP Chemical)是SK海力士前驱体核心供应商</strong>，同时供货合肥长鑫，国家大基金入股。前驱体用于HBM堆叠介质层薄膜沉积，<strong>技术贯穿HBM全世代</strong>，深度绑定全球HBM绝对龙头。', tags:['海力士核心供应商','全世代刚需','大基金入股','绑定长鑫'],
    ...
    ], note:'初始清单，需手动核查后切换状态' } , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:5,trend:'up'}], dims6Note:'🆪 子公司韩国先科为海力士HBM前驱体核心供、绑定全世代；但26Q1营收-6.85%(LNG交付拖累)、业绩平淡——长线卡口买点看估值', tier:'media', src:'绑定海力士=招股书+季报/海力士占比50%=media estimate待核 ⚪单源待核'},
  { rank:3, name:'拓荆科技', code:'688072', segment:'混合键合/HBM设备', strength:'★★☆', logic:'<strong>国产唯一量产PECVD</strong>，薄膜沉积国内市占>25%，<strong>深度参与HBM混合键合研发</strong>，HBM设备国产化率>50%，存储双雄订单占比高。混合键合核心设备仍受Besi垄断→暂列潜在卡口(3/4)，若量产突破可升级。', tags:['PECVD国产唯一','HBM设备国产化>50%','混合键合追赶','存储双雄绑定'],
    valuation:{ pe:'🆪 高', pePercentile:75, grossMargin:'设备毛利较高', fromHigh:'—', asOf:'2026-06-13', note:'🆪 AI估值初版：HBM设备弹性大，但混合键合量产突破前估值已抢跑，注意节奏；周一cron覆盖' },
    verification:{ items:[
