...
CHAINS.hbm.segments = [
  {
    ...
    stocks:[
      ...
      { rank:2, name:'北方华创', code:'002371', position:'国内最大平台型设备商，全球第5', barrier:'极高', hits:3, strength:'★★☆', trend:'up', trendNote:'刻蚀/薄膜/键合全布局', logic:'覆盖刻蚀/薄膜/清洗/热处理，HBM相关键合与刻蚀设备布局，在手订单饱满，国产替代平台龙头' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:5,trend:'up'}], dims6Note:'🆪 Q1营收103.23亿+25.8%/净利16.35亿+3.42%(研发拖累)；HBM混合键合Qomola HPD30；平台龙头、估值高(PE~57x)', tier:'primary', valAsOf:'2026-06-13', src:'Q1营收/净利=公司一季报+同花顺/平台龙头=招股书+行业协会'},
      ...
      { rank:4, name:'华海清科', code:'688120', position:'国产CMP/减薄设备唯一量产', barrier:'高', hits:null, strength:null, trend:'up', trendNote:'晶圆减薄受益HBM堆叠', logic:'HBM超薄晶圆堆叠需多次减薄，国产减薄/CMP唯一量产，导入存储产线' , dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:4,trend:'up'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:4,trend:'up'}], dims6Note:'🆪 ⚠️CMP/减薄设备(非华海诚科)；Q1营收+31.66%/净利2.47亿仅+5.95%；HBM减薄国产唯一', tier:'primary', valAsOf:'2026-06-13', src:'Q1营收/净利=公司一季报/CMP+减薄定位=招股书+券商'},
  ...
  },
  {
    ...
    stocks:[
      { rank:1, name:'雅克科技', code:'002409', position:'子公司韩国先科=SK海力士前驱体核心供应商', barrier:'极高', hits:4, strength:'★★★', trend:'up', trendNote:'绑定海力士+长鑫，HBM全世代受益', logic:'子公司UP Chemical为全球半导体前驱体龙头，SK海力士与合肥长鑫核心供应商，海力士收入占比~50%，大基金入股，技术贯穿HBM全世代' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:5,trend:'up'}], dims6Note:'⚪ 海力士+长鑫前驱体核心供、绑定全世代；26Q1营收-6.85%(LNG拖累)、长线卡口买点看估值 · 估值参考 PE-TTM ~58x 截至2026-06-10', tier:'media', valAsOf:'2026-06-10', src:'海力士+长鑫=招股书+季报/Q1-6.85%=公司一季报/PE-TTM=4/23 broker 收盘 ⚪海力士占比50%=media单源待核'},
...
CHAINS.hbm.midstream = {
  ...
  stocks:[
    ...
    { rank:11, name:'沃格光电', code:'603773', barrier:'高', trend:'up', note:'TGV玻璃通孔(CoWoS/CoPoS下一代)，台积电CoPoS验证中、订单90亿+' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:4,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:4,trend:'flat'}], dims6Note:'⚪ TGV玻璃通孔(CoWoS/CoPoS下一代),Q1净利预增180-220%(自媒体口径、待核财报),进台积电CoPoS验证、订单90亿+;高弹性高估值', tier:'media', src:'净利预增=自媒体口径待核/TGV台积电=公司公告+调研纪要 ⚪单源待核'}
  ]
};
