...
CHAINS.hbm.segments = [
  ...
  },
  {
    ...
    stocks:[
      { rank:1, name:'雅克科技', code:'002409', position:'子公司韩国先科=SK海力士前驱体核心供应商', barrier:'极高', hits:4, strength:'★★★', trend:'up', trendNote:'绑定海力士+长鑫，HBM全世代受益', logic:'子公司UP Chemical为全球半导体前驱体龙头，SK海力士与合肥长鑫核心供应商，海力士收入占比~50%，大基金入股，技术贯穿HBM全世代' , dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:5,trend:'up'},{key:'supply',score:5,trend:'up'},{key:'valuation',score:3,trend:'flat'},{key:'barrier',score:5,trend:'up'}], dims6Note:'⚪ 海力士+长鑫前驱体核心供、绑定全世代；26Q1营收-6.85%(LNG拖累)、长线卡口买点看估值 · 估值参考 PE-TTM ~58x 截至2026-06-10', tier:'estimate', valAsOf:'2026-06-10', src:'海力士+长鑫=招股书+季报/Q1-6.85%=公司一季报/PE-TTM=4/23 broker 收盘'},
