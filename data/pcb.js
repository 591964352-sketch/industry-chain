...
CHAINS.pcb.segments = [
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'沪电股份', code:'002463', position:'GB200/GB300 交换机及高多层板核心供应商之一，与景旺电子等共同供应（非独家）；78 层 M9 正交背板已通过英伟达认证并量产', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'2026Q1/2025年报+券商研报', trend:'up', trendNote:'GB200 22层量产·GB300 112G/224G背板·Rubin+233%·AMD扩产·谷歌TPU v5·Meta自研背板验证·Q1+78%',
        ...
        dims6Note:'🟢 GB200 22层高多层批量(2025-Q1 broker双源·华泰+中信)+GB300 112G/224G高速背板(2025-Q3 primary)+Rubin机架PCB价值+233%(2026-Q1 broker双源·天风+杰富瑞)+英伟达NVL288独家供应(2025-Q4 broker双源);昆山55亿项目22-32层AI主板+高速背板(2025-08-26 primary+海通双源)/良率98%+;Q1营收62.14亿+53.91%/净利12.42亿+62.9%/AI营收占比~60%/英伟达份额>50%;2025净利38.22亿+47.74%;⚠️AI服务器PCB市占扩大(天风单源)+昆山项目2026下半年试产具体时间未查到', src:'2026Q1/2025年报' },
      { rank:2, name:'胜宏科技', code:'300476', position:'英伟达显卡PCB全球份额约50%(一供,Prismark 2026);GB300 OAM子板核心供应商;2025年AI业务营收83.4亿(占比43%、同比+11倍、毛利率40-45%),在手订单饱满排至2026年底(v3 豆包联网核实)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'2026Q1/2025年报+Prismark', trend:'up', trendNote:'GB300 OAM核心·显卡PCB全球50%·谷歌微软ASIC·字节阿里云·Q1 15.2亿',
        ...
        dims6Note:'🟢 GB200 6阶24层HDI批量(2025-Q1 broker双源·中泰+招商)+GB300 OAM子板核心(2025-Q3 primary)+70层超高层数板(2026-Q1 broker双源);英伟达显卡PCB全球50%(2025-Q4 Prismark+中泰双源·A股PCB净利首位);新增谷歌/微软ASIC(2026-Q2 broker双源·招商+东方);mSAP产线满产良率70-80%(primary+中泰);Q1营收55.19亿+28%/净利12.88亿+40%/2025净利43.12亿+273.52%;⚠️显卡PCB全球50%双源验证待核+良率70-80%(中泰单源)+L4"旭创/新易盛"光模块厂pcb.js无旧值+mSAP良率提升85%+具体措施未查到', src:'2026Q1/2025年报' },
      { rank:3, name:'东山精密', code:'002384', position:'边缘AI设备PCB全球第一(2025市占26.9%)·全球PCB前3(市占4.2%)·FPC软板全球第二(市占24.5%)·含光模块业务(索尔思光电 IDM 国内唯一 200G EML)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'2026Q1/2025年报+Prismark', trend:'up', trendNote:'28层GB200+32层GB300·1.6T光模块·Meta自研背板·Rubin样品·Q1+143%',
        ...
        dims6Note:'🟢 28层GB200 AI主板批量(2025-Q1 broker双源·东北+民生)+1.6T光模块PCB(2025-Q3 primary)+32层GB300 AI背板(2026-Q1 broker双源);Rubin平台28-32层订单(2026-Q1 broker双源)+光模块营收占比20%(2026-Q2 primary);AI PCB良率98%+/mSAP+任意层互连核心技术+200万㎡/年新增产能(broker双源);Q1营收131.38亿+52.72%/净利8.5亿+143%/扣非+167%;⚠️光模块PCB市占率提升(东北单源)+200万㎡/年AI PCB具体投产时间未查到', src:'2026Q1/2025快报' },
      { rank:4, name:'景旺电子', code:'603228', position:'2024年首次成为全球第一大汽车PCB供应商(2023年已进全球前三);英伟达H100/GB300交换机托盘核心供应商之一,与日本名幸等共同供应GB200服务器UBB基板', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'Rubin中板40%+·正交背板25%+·Switch板·车载PCB全球9%·Q1+62%',
        ...
        dims6Note:'🟢 Rubin中板40%+(2025-Q1 broker双源·麦高+国信)+Switch板20-25%(2025-Q3 primary)+正交背板25%+(2026-Q1 broker双源);汽车PCB全球第一9%(2026-Q1 broker双源·麦高+国信);新增国内头部AI芯片厂商(2026-Q2 primary);AI PCB良率97%+150万㎡/年新增产能(broker双源);Q1营收38.92亿/净利2.33亿同比+50%/毛利率18.76%;⚠️"汽车PCB与AI PCB协同"(麦高单源)+150万㎡/年具体投产时间未查到;⚠️AI纯度低·弹性弱于纯AI龙头·诚实保留' },
      { rank:5, name:'鹏鼎控股', code:'002938', position:'全球PCB营收连续9年第一·FPC软板全球第二(2025市占25%)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'2026Q1/2025年报+Prismark', trend:'up', trendNote:'GB200 20层·GB300 HDI·9连冠·AI暴露5.41%·海外云厂商小批量·Q1-10%',
        ...
        dims6Note:'🟢 GB200 20层AI服务器PCB批量(2025-Q1 broker双源·兴业+长江)+GB300 HDI板(2025-Q3 primary)+24层AI背板(2026-Q1 broker双源);全球PCB营收9连冠+FPC软板全球第二25%(broker双源);AI服务器板仅占营收5.41%(大而不纯AI);Q1营收79.86亿-1.25%/净利4.63亿-5.21%/扣非-31.85%(业绩走弱);任意层互连+mSAP良率99%+全球领先/10大生产基地;⚠️AI业务增长潜力(兴业单源)+新增300万㎡/年AI PCB具体投产时间未查到;⚠️AI暴露小·"大而不纯AI"诚实保留', src:'2026Q1/2025年报' }
    ]
  }
];
...
(function(){
  ...
  Object.keys(REG).forEach(code => {
    ...
    const finalStrength = orig?.strength || '★★☆';
    ...
    DERIVED.push({
      ...
      name: s.name,
      segment: segment,
      rate: gapRate(segment),   // 排序键·同时保留作渲染参考
      strength: finalStrength,
      strengthRank: strengthRank(finalStrength),  // ★ 用 fallback 后的值
      logic: orig?.logic || `（占位·待补）${s.name} 卡口逻辑 150 字（barrier='极高' 自动筛入·原 chokePoints 列表无注解·待联网核实）`,
      valuation: orig?.valuation || autoVal || null,
