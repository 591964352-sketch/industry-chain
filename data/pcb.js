...
CHAINS.pcb.segments = [
  {
    ...
    stocks: [
      { rank:1, name:'生益科技', code:'600183', position:'全球高端覆铜板第一梯队·M9等级大陆唯一进入英伟达供应链(与台光/松下并列三大供应商)·全球市占14-15%', barrier:'极高', tier:'primary', valAsOf:'2026-04-26', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M9大陆唯一·Q1净利+105%', logic:'<mark class="updated">2026Q1营收81.41亿+45%，净利11.58亿+105%</mark>。M9 CCL已批量供货英伟达供应链，全球市占14-15%，Q1毛利率28.10%;PE-TTM 110.93倍(3年分位97.81%,asOf:2026-06-16) ⚠️口径待统一:position M9市占30-40% vs logic全球市占14-15%——口径不同(细分品类M9 vs 整体CCL) ⚠️待核≥2源:M9大陆唯一表述(国信/东方财富财富号 ≥2源已核实✅)',
      ...
      { rank:2, name:'华正新材', code:'603186', position:'华为昇腾CCL核心供·CBF积层膜对标味之素ABF', barrier:'高', tier:'primary', valAsOf:'2026-04-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'CBF膜切入华为/中芯·Q1毛利率12%偏低', logic:'<mark class="updated">2026Q1营收12.34亿、归母0.31亿、毛利率12.02%</mark>(2026-04-22季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 111.70倍(3年分位98.53%,asOf:2026-06-16)。AI服务器用高等级CCL+CBF膜切入华为/中芯,国产替代直接受益',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:3,trend:'flat',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:3,trend:'flat',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:4,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 CBF 膜国产替代潜力,业绩兑现尚需时间;Q1毛利率12%偏低;PE-TTM 111.70倍/3年分位98.53%(asOf 2026-06-16)——估值已不便宜' },
      { rank:3, name:'南亚新材', code:'603519', position:'覆铜板A股第三·M8量产M9测试中', barrier:'高', tier:'primary', valAsOf:'2026-04-28', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'高速材料M8→M9·Q1毛利率15.71%', logic:'<mark class="updated">2026Q1营收3.95亿、归母0.34亿、毛利率15.71%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 24.05倍(3年分位40.44%,asOf:2026-06-16)。高速材料从M8→M9追赶中,AI服务器订单加速放量',
      ...
      { rank:4, name:'金安国纪', code:'002636', position:'国内龙头·全球CCL第7', barrier:'中', tier:'primary', valAsOf:'2026-04-29', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'涨价标杆·AI暴露弱·Q1净利2.02亿', logic:'<mark class="updated">2026Q1营收12.60亿、归母2.02亿、毛利率26.44%</mark>(2026-04-29季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 154.18倍(3年分位81.00%,asOf:2026-06-16)。涨价期情绪标杆,中低端CCL为主,AI暴露弱',
      ...
      { rank:5, name:'超华科技', code:'002288', position:'中端覆铜板+铜箔一体化·铜箔营收占比30%', barrier:'中', tier:'primary', valAsOf:'2024-11-13', src:'②待补(akshare无2026Q1数据)', trend:'down', trendNote:'中端CCL·AI纯度低·PE-TTM失真', logic:'②待补(akshare无2026Q1数据,最新一期为2024Q3亏损期,2024-11-13披露)。中端覆铜板+铜箔,AI纯度低,5G/汽车转型中;PE-TTM 失真(2024-08-18起持续负值,亏损期)',
        ...
        dims6Note:'🟢 中端 CCL+铜箔一体化,AI 纯度低,转型阵痛;②待补(akshare无2026Q1数据,数据停2024Q3);PE-TTM失真(亏损期,asOf 2024-08-18)' }
    ]
  },
  {
    ...
    stocks: [
      { rank:1, name:'东材科技', code:'601208', position:'全球唯二M9碳氢树脂认证·国内唯一', barrier:'极高', tier:'primary', valAsOf:'2026-04-23', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'Q1+103%·台光排他', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收14.44亿、归母净利1.87亿+103%、毛利率17.13%</mark>(2026-04-23季报,tier:primary,src:akshare/新浪财经(基于公司季报));高速电子树脂营收2.58亿+131%;PE-TTM 190.51倍(3年分位99.85%,asOf:2026-06-16)。台光独供2-3年排他协议。眉山3500吨<mark class="updated">2026年6月30日投料试产(提前至Q2末)</mark>。高速电子级碳氢树脂供应商·价格/毛利率数据待2025年报树脂业务分项披露后核实 ⚠️口径待统一:价格80-120万元/吨+毛利50%+,协会极少披露价格区间 ⚠️单源待核:价格80-120万元/吨+毛利50%+(协会极少披露) ⚠️asOf待核:眉山3500吨 2026/6/30 投料试产 应标具体披露日(迫近 2026-06-16)',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:3,trend:'flat',tier:'estimate'},{key:'policy',score:4,trend:'up',tier:'estimate'},{key:'supply',score:5,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:5,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 M9 树脂唯一国产,壁垒+供需双满分、业绩未放量——赔率/左侧派(样板 §3.2 原文);Q1毛利率17.13%;PE-TTM 190.51倍/3年分位99.85%(asOf 2026-06-16)——估值已透支' },
      { rank:2, name:'圣泉集团', code:'605589', position:'PPO国内唯一量产·全球第四 ⚠️待核≥2源:PPO国内唯一量产(彤程新材也称对标SABIC PPO)', barrier:'高', tier:'primary', valAsOf:'2026-04-25', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'PPO国产70%·碳氢投产', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收26.71亿、归母1.77亿、毛利率26.25%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 58.08倍(3年分位99.87%,asOf:2026-06-16)。PPO国内规模化量产领先(现有产能1300-1800吨/年,2026Q3新增2000吨/年项目投产)·碳氢树脂2026Q4投产1500吨,向上突破 ⚠️待核≥2源:"PPO国内唯一量产"未找到协会/研报≥2源支撑 ⚠️单源待核:"国产市占70%"未找到来源支撑,建议改为"待核"或删除',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:3,trend:'flat',tier:'estimate'},{key:'policy',score:4,trend:'up',tier:'estimate'},{key:'supply',score:4,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:4,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 PPO 国产唯一+碳氢扩产,业绩待 Q4 投产兑现;Q1毛利率26.25%尚可;PE-TTM 58.08倍/3年分位99.87%(asOf 2026-06-16)——估值高位' },
      { rank:3, name:'世名科技', code:'300522', position:'盘锦500吨已投产·M9方案已认证 ⚠️单源待核:盘锦500吨已投产 vs logic规划2500吨混淆 ⚠️待核:具体产能数字(500吨/2500吨)未找到协会/公告≥2源核实', barrier:'高', tier:'primary', valAsOf:'2026-04-15', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M9方案已认证·扩产·Q1净利0.02亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收1.52亿、归母0.02亿、毛利率25.26%</mark>(2026-04-15季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 251.48倍(3年分位79.64%,asOf:2026-06-16)。已通过台光/生益/联茂M9方案认证,规划总产能2500吨·H2放量 ⚠️口径待统一:盘锦500吨已投产 vs position 2500吨,当前 vs 规划混淆',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:3,trend:'flat',tier:'estimate'},{key:'policy',score:4,trend:'up',tier:'estimate'},{key:'supply',score:4,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:4,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 M9 方案已认证,500 吨小批量、扩产爬坡中;Q1净利0.02亿(扭亏边缘);PE-TTM 251.48倍/3年分位79.64%(asOf 2026-06-16)——估值偏高' },
      { rank:4, name:'宏昌电子', code:'603002', position:'环氧树脂龙头·GBF增层膜送样', barrier:'中', tier:'primary', valAsOf:'2026-04-29', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'环氧树脂壁垒低·Q1净利0.005亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收9.89亿、归母0.005亿、毛利率4.87%</mark>(2026-04-29季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 813.95倍(3年分位99.84%,asOf:2026-06-16)。GBF增层膜送样台积电/长电,但环氧树脂壁垒低→非卡口;Q1毛利率仅4.87%,业绩弹性极弱',
        ...
        dims6Note:'🟢 GBF 膜送样,但环氧树脂壁垒低,非卡口;Q1毛利率4.87%极低/净利0.005亿扭亏边缘;PE-TTM 813.95倍/3年分位99.84%(asOf 2026-06-16)——估值严重透支' },
      { rank:5, name:'彤程新材', code:'603650', position:'电子级酚醛树脂·对标SABIC PPO', barrier:'中', tier:'primary', valAsOf:'2026-04-18', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'PPO对标SABIC·AI弱·Q1净利1.82亿', logic:'<mark class="updated">2026Q1营收10.49亿、归母1.82亿、毛利率22.21%</mark>(2026-04-18季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 67.42倍(3年分位82.14%,asOf:2026-06-16)。电子级酚醛稳定供应·PPO对标SABIC·AI暴露弱',
        dims6:[{key:'durability',score:3,trend:'flat',tier:'estimate'},{key:'visibility',score:2,trend:'flat',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:3,trend:'flat',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:2,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 电子级酚醛+PPO 对标,AI 暴露弱;Q1毛利率22.21%;PE-TTM 67.42倍/3年分位82.14%(asOf 2026-06-16)——估值偏高' }
    ]
  },
  {
    ...
    stocks: [
      ...
      { rank:2, name:'宏和科技', code:'603256', position:'4μm极薄布全球唯一量产·全球市占~50%', barrier:'高', tier:'primary', valAsOf:'2026-04-17', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'4μm超薄布全球第一·Q1毛利率55.65%', hits:3, strength:'★★☆', logic:'<mark class="updated">2026Q1营收4.42亿、归母1.40亿、毛利率55.65%</mark>(2026-04-17季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 731.03倍(3年分位99.82%,asOf:2026-06-16)。超薄电子布全球市占~50%。但非AI最核心瓶颈→降级',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:3,trend:'flat',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:4,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:4,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 4μm 超薄布全球唯一,但非 AI 最核心瓶颈;Q1毛利率55.65%极高;PE-TTM 731.03倍/3年分位99.82%(asOf 2026-06-16)——估值严重透支' },
      { rank:3, name:'中材科技', code:'002080', position:'国内Low Dk市占35%·石英布独供胜宏GB300', barrier:'中', tier:'primary', valAsOf:'2026-04-25', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'石英布独供GB300·送样Rubin·Q1净利5.07亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收68.54亿、归母5.07亿、毛利率20.94%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 64.04倍(3年分位94.77%,asOf:2026-06-16)。Q布占比仅20-30%,非前三寡头·主业玻纤稳',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:3,trend:'flat',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:3,trend:'flat',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:2,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 石英布独供 GB300,Q布占比仅 20-30%;Q1净利5.07亿;PE-TTM 64.04倍/3年分位94.77%(asOf 2026-06-16)——估值偏高' },
      { rank:4, name:'中国巨石', code:'600176', position:'电子布销量A股第一·全球玻纤龙头', barrier:'中', tier:'primary', valAsOf:'2026-04-25', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'高端电子布扩产·AI纯度升·Q1净利12.67亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收52.82亿、归母12.67亿、毛利率39.64%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 51.99倍(3年分位84.05%,asOf:2026-06-16)。全球玻纤龙头,但非Q布寡头·AI纯度低',
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'铜冠铜箔', code:'301217', position:'国内唯一HVLP1-4全系列量产·2027市占预期42% ⚠️待核≥2源:日韩四强垄断85%+(Prismark)', barrier:'极高', tier:'primary', valAsOf:'2026-04-28', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'设备锁定70%·2027市占42%·Q1净利1.06亿', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收18.42亿、归母1.06亿、毛利率8.79%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 899.30倍(3年分位25.00%,asOf:2026-06-16)。<mark class="updated">锁定10台三船MSP-8000表面处理机(全球70%),产能确定性最强</mark>。2026目标500吨/月。日韩四强垄断85%+。设备交期18-24月。2027市占率预期42%。已实现HVLP4规模化量产 ⚠️口径待统一:2027中国1厂42% vs 日韩合计85%+,两口径统计基础不同 ⚠️单源待核:锁定10台三船MSP-8000(全球70%)+2026目标500吨/月+2027市占42%+设备交期18-24月 四数据全单源',
      ...
      { rank:2, name:'德福科技', code:'301511', position:'进入英伟达供应链·电子电路铜箔年产能5万吨可柔性切换·HVLP4已在部分客户小规模放量(2025年报)·HVLP5完成样品认证', barrier:'高', tier:'primary', valAsOf:'2026-04-25', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'5万吨切换·HVLP4验证', hits:3, strength:'★★☆', logic:'<mark class="updated">2026Q1营收43.38亿、归母1.47亿、毛利率9.11%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 442.65倍(3年分位21.94%,asOf:2026-06-16)。2025年报:电子电路铜箔年产能5万吨可柔性切换。HVLP4已在部分客户小规模放量(较"验证中"更进一步)·HVLP5完成样品认证。机构关注度高→降级',
      ...
      { rank:3, name:'诺德股份', code:'600110', position:'6μm极薄铜箔量产·服务器铜箔市占>25%·2026Q1扭亏', barrier:'中', tier:'primary', valAsOf:'2026-04-23', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'6μm·Q1扭亏·HVLP4量产·PE失真', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收25.43亿、归母0.40亿、毛利率11.71%</mark>(2026-04-23季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 失真(-123.02倍,2026-06-16,扭亏微利期)。服务器PCB用铜箔市占>25%,但HVLP4仍在认证',
      ...
      { rank:4, name:'嘉元科技', code:'688388', position:'极薄铜箔4.5μm市占>50%', barrier:'中', tier:'primary', valAsOf:'2026-04-27', src:'2026Q1季报(2026-04-27)+新浪财经2026-04-29', trend:'up', trendNote:'锂电转HVLP·2026Q1净利+392.77%', hits:null, strength:null, logic:'2026Q1归母净利润1.21亿元(+392.77%),扣非净利1.09亿元(+1208%),营收34.45亿元(+73.94%)(2026-04-27季报)·锂电铜箔转产HVLP;PE-TTM 211.04倍(3年分位92.40%,asOf:2026-06-16)',
      ...
      { rank:5, name:'中一科技', code:'688234', position:'高性能电子铜箔·HVLP4在研', barrier:'中', tier:'primary', valAsOf:'2026-04-29', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'高性能铜箔·主业稳', logic:'<mark class="updated">2026Q1营收3.66亿、归母-0.61亿(亏损)、毛利率19.12%</mark>(2026-04-29季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 失真(-245.85倍,2026-06-16,亏损期估值失真)。锂电铜箔主业转HVLP4,AI暴露弱·业绩弹性待验证',
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'深南电路', code:'002916', position:'国内唯一ABF载板批量交付·全球PCB营收前10', barrier:'极高', tier:'primary', valAsOf:'2026-04-24', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'ABF国内唯一·Q1+73%·净利8.50亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收65.96亿、归母8.50亿、毛利率29.17%</mark>(2026-04-24季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 75.69倍(3年分位99.60%,asOf:2026-06-16)。广州60亿投资2亿颗FC-BGA/年。Q1净利+73%。封装基板营收41.48亿+30.8%',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:4,trend:'up',tier:'estimate'},{key:'policy',score:4,trend:'up',tier:'estimate'},{key:'supply',score:4,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:5,trend:'flat',tier:'estimate'}],
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'鼎泰高科', code:'301377', position:'PCB钻针全球第一(2024年市占26.8%/2025H1进一步提升至28.9%,Frost&Sullivan数据) ⚠️口径待统一:钻针全球第一26.8% vs 同段金洲精工20.8% 全球第二,合计47.6%留52%+给其他 ⚠️时序已更新:原26.5%是2023年Prismark旧数据,本次更新为最新', barrier:'高', tier:'primary', valAsOf:'2026-04-16', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'钻针全球第一·AI高多层', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收8.14亿、归母2.61亿、毛利率53.25%</mark>(2026-04-16季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 366.38倍(3年分位99.87%,asOf:2026-06-16)。2025年报(2026-03-26):归母净利4.34亿元(+91.1%),毛利率42.34%(+6.54pct),扣非净利4.09亿元(+102.5%)·AI高多层板钻针耗量激增 ⚠️口径待统一:同position 26.8% + 20.8% 合计47.6% 张力 ⚠️单源待核:"钻孔数10万→50万+"工艺数字未找到年报/研报对应来源,建议删除或标"单源待核"',
      ...
      { rank:2, name:'大族数控', code:'301200', position:'钻孔设备全球第二·AI高多层板设备市占40-50%', barrier:'高', tier:'primary', valAsOf:'2026-04-21', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'2025年报净利+173.68%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收19.55亿、归母3.23亿、毛利率33.12%</mark>(2026-04-21季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 154.71倍(3年分位99.87%,asOf:2026-06-16)。2025年报(2026-03-31):营业总收入57.73亿元(+72.68%),归母净利润8.24亿元(+173.68%),扣非净利8.21亿元(+290.92%)·AI高多层板设备市占40-50%',
      ...
      { rank:3, name:'芯碁微装', code:'688630', position:'PCB直接成像设备全球市占率18.8%(2025年,收入口径,全球第一,领先第二名3.1pct)·全球唯一覆盖PCB/IC载板/先进封装/掩膜版四场景的企业(灼识咨询·港交所招股书)', barrier:'高', tier:'primary', valAsOf:'2026-04-30', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'3-4μm小批量·双催化·Q1毛利率40.94%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收5.15亿、归母1.08亿、毛利率40.94%</mark>(2026-04-30季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 176.36倍(3年分位99.87%,asOf:2026-06-16)。2026年港交所招股书(灼识咨询):PCB直接成像设备2025年全球市占18.8%(收入口径,全球第一,领先第二名3.1pct)·2026年1-2月单月设备交付量65-68台(交付量非订单量)·全球唯一覆盖PCB/IC载板/先进封装/掩膜版四场景企业 ⚠️单源待核:原"3-4μm线宽+2026激光钻孔订单70-100台"未找到对应来源,本次整体替换为招股书数据',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:4,trend:'up',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:4,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:4,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 PCB直接成像设备全球第一(2025市占18.8%)+港交所招股书披露四场景覆盖;Q1净利1.08亿/毛利率40.94%极强;PE-TTM 176.36倍/3年分位99.87%(asOf 2026-06-16)——估值严重透支' },
      { rank:4, name:'东威科技', code:'688700', position:'VCP电镀国内市占>50%·AI订单>5亿', barrier:'中', tier:'primary', valAsOf:'2026-04-28', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'AI订单>5亿·Q1净利0.44亿·毛利率37.25%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收3.05亿、归母0.44亿、毛利率37.25%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 197.00倍(3年分位91.87%,asOf:2026-06-16)。AI订单>5亿。三合一电镀设备打破海外垄断',
        dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:4,trend:'up',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:4,trend:'up',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:2,trend:'flat',tier:'estimate'}],
        dims6Note:'🟢 VCP 电镀国内>50%+AI 订单>5 亿;Q1净利0.44亿/毛利率37.25%极强;PE-TTM 197.00倍/3年分位91.87%(asOf 2026-06-16)——估值严重透支' },
      { rank:5, name:'金洲精工', code:'002443', position:'PCB钻针全球第二·市占20.8% ⚠️口径待统一:鼎泰26.8%(2024)/28.9%(2025H1,Frost&Sullivan) + 金洲20.8% 合计47.6%,与原26.5%+20.8%=47.3%略有差异(因鼎泰数据时序更新) ⚠️时序待核:金洲20.8%数据对应年份未独立核实', barrier:'中', tier:'primary', valAsOf:'2026-04-28', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'钻针全球第二·市占20.8%·Q1净利0.40亿', logic:'<mark class="updated">2026Q1营收9.36亿、归母0.40亿、毛利率13.03%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 40.23倍(3年分位78.24%,asOf:2026-06-16)。PCB钻针老牌厂商,被鼎泰高科高端化替代·AI纯度低',
        dims6:[{key:'durability',score:3,trend:'flat',tier:'estimate'},{key:'visibility',score:2,trend:'flat',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:3,trend:'flat',tier:'estimate'},{key:'valuation',score:2,trend:'up',tier:'estimate'},{key:'barrier',score:2,trend:'flat',tier:'estimate'}],
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'沪电股份', code:'002463', position:'英伟达AI服务器PCB全球市占率约40%(多源一致);GB200/GB300交换机及高多层板核心供应商之一', barrier:'高', tier:'primary', valAsOf:'2026-06-13', src:'2026Q1/2025年报+券商研报', trend:'up', trendNote:'AI营收占比升至~60%',
        ...
        logic:'为英伟达H100/H200提供22-26层高多层板,H200 UBB主板份额超70%(截至2025年,研报口径);与景旺电子等共同供应GB200服务器UBB基板/PCB组件(非独家);2025年10月泰国工厂投产,承接GB300订单,为下一代产品预留产能;PE-TTM 62.91倍(3年分位90.48%,asOf:2026-06-16)',
      ...
      { rank:2, name:'胜宏科技', code:'300476', position:'英伟达显卡PCB全球份额约50%(一供);GB300 OAM子板核心供应商', barrier:'高', tier:'primary', valAsOf:'2026-06-13', src:'2026Q1/2025年报+Prismark', trend:'up', trendNote:'A 股 PCB 净利首位',
        ...
        dims6Note:'🟢 AI弹性最大：2025净利43.12亿+273.52%(A股PCB首位)、26Q1净利12.88亿+40%;PE-TTM 74.65倍(3年分位95.98%,asOf:2026-06-16)(营收55.19亿+28%)、显卡/AI算力卡PCB领先。估值高位为扣分项(随股价刷新)。', src:'2026Q1/2025年报' },
      { rank:3, name:'东山精密', code:'002384', position:'边缘AI设备PCB全球第一(2025市占26.9%)·全球PCB前3(市占4.2%)·FPC软板全球第二(市占24.5%)', barrier:'高', tier:'primary', valAsOf:'2026-04-26', src:'2026Q1/2025年报+Prismark', trend:'up', trendNote:'Q1+143%·含光模块',
        ...
        logic:'子公司Multek 78层+高层数PCB量产适配英伟达GB200；2025收购索尔思光电(国内唯一量产200G EML光芯片IDM)·800G光模块批量交付Meta/微软·1.6T通过英伟达验证(2026Q4量产)；珠海10亿美元高端PCB基地2026Q3投产;PE-TTM 223.61倍(3年分位82.50%,asOf:2026-06-16)',
      ...
      { rank:4, name:'景旺电子', code:'603228', position:'2024年首次成为全球第一大汽车PCB供应商(2023年已进全球前三);英伟达H100/GB300交换机托盘核心供应商之一,与日本名幸等共同供应GB200服务器UBB基板', barrier:'中', tier:'primary', valAsOf:'2026-04-23', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'汽车PCB全球第一·Q1净利2.33亿',
        dims6:[{key:'durability',score:4,trend:'up'},{key:'visibility',score:3,trend:'flat'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:3,trend:'flat'},{key:'valuation',score:2,trend:'up'},{key:'barrier',score:3,trend:'flat'}],
        logic:'<mark class="updated">2026Q1营收38.92亿、归母2.33亿、毛利率18.76%</mark>(2026-04-23季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 67.58倍(3年分位99.42%,asOf:2026-06-16)。2023年4月获英伟达合格供应商认证,2024年高阶HDI一次性通过认证(国内少数实现该突破的企业之一);正交背板项目获研发标(具体份额口径仅见单一媒体源,待核);2026年全年规划新增约200万平米高端产能(珠海金湾+泰国基地,泰国工厂2026年投产)',
      ...
      { rank:5, name:'鹏鼎控股', code:'002938', position:'全球PCB营收连续9年第一·FPC软板全球第二(2025市占25%)', barrier:'高', tier:'primary', valAsOf:'2026-05-22', src:'2026Q1/2025年报+Prismark', trend:'up', trendNote:'9连冠·AI暴露小',
        ...
        logic:'主营FPC/SLP/HDI/高多层刚性板,覆盖AI服务器/光模块/交换机；2026-01-15调研纪要披露"算力直接客户订单导入元年",AI多场景布局推进中；但26Q1营收79.86亿同比-1.25%/归母净利4.63亿同比-5.21%,AI业务尚未兑现到整体业绩;PE-TTM 67.54倍(3年分位99.58%,asOf:2026-06-16)',
...
CHAINS.pcb.midstream = {
  ...
  stocks: [
    ...
    { rank:4, name:'鹏鼎控股', code:'002938', barrier:'高', tier:'primary', valAsOf:'2026-05-22', src:'2026Q1/2025快报', trend:'flat', trendNote:'苹果链FPC·消费占比高', note:'全球PCB营收9连冠·苹果链FPC主供，消费电子占比~70%→AI转型中 ⚠️与seg[6] r5鹏鼎:26Q1双下滑+AI元年叙事张力已独立核;PE-TTM 67.54倍(3年分位99.58%,asOf:2026-06-16)',
