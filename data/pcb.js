    ...
    midstream: [
      {
        ...
        companies: [
          ...
          { name:'沪电股份', code:'002463', position:'AI 服务器+汽车 PCB 双龙头·78 层背板认证 + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 多源券商) + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 多源券商)', barrier:'极高' },
...
CHAINS.pcb.segments = [
  {
    ...
    stocks: [
      { rank:1, name:'生益科技', code:'600183', position:'全球高端覆铜板第一梯队·M9等级大陆唯一进入英伟达供应链(与台光/松下并列三大供应商)·全球市占14-15% + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 英伟达供应链公告) + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 英伟达供应链公告)', barrier:'极高', tier:'primary', valAsOf:'2026-04-26', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M9大陆唯一·Q1净利+105%', logic:'<mark class="updated">2026Q1营收81.41亿+45%，净利11.58亿+105%</mark>。M9 CCL已批量供货英伟达供应链，全球市占14-15%，Q1毛利率28.10%;PE-TTM 113.69倍(3年分位97.81%,asOf:2026-06-20) ⚠️口径待统一:position M9市占30-40% vs logic全球市占14-15%——口径不同(细分品类M9 vs 整体CCL) ⚠️待核≥2源:M9大陆唯一表述(国信/东方财富财富号 ≥2源已核实✅)',
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'深南电路', code:'002916', position:'国内唯一ABF载板批量交付·大陆内资ABF市占~63%·全球PCB营收前10', barrier:'极高', tier:'primary', valAsOf:'2026-04-24', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'ABF国内唯一·Q1+73%·净利8.50亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收65.96亿、归母8.50亿、毛利率29.17%</mark>(2026-04-24季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 85.05倍(3年分位99.60%,asOf:2026-06-20)</mark>。广州60亿投资2亿颗FC-BGA/年。Q1净利+73%。封装基板营收41.48亿+30.8%',
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'沪电股份', code:'002463', position:'英伟达AI服务器PCB全球市占率约40%(多源一致);GB200/GB300交换机及高多层板核心供应商之一', barrier:'高', tier:'primary', valAsOf:'2026-06-13', src:'2026Q1/2025年报+券商研报', trend:'up', trendNote:'AI营收占比升至~60%',
        ...
        logic:'为英伟达H100/H200提供22-26层高多层板,H200 UBB主板份额超70%(截至2025年,研报口径);与景旺电子等共同供应GB200服务器UBB基板/PCB组件(非独家);2025年10月泰国工厂投产,承接GB300订单,为下一代产品预留产能;PE-TTM 66.16倍(3年分位90.48%,asOf:2026-06-20)',
