...
CHAINS.pcb.segments = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { rank:3, name:'世名科技', code:'300522', position:'盘锦500吨已投产·M9方案已认证 ⚠️→✅ R3-11 豆包反核实:500吨已投产+2500吨为2026年扩产目标,无混淆(东方证券 2026-06-17 + 公司公告 2026-06-17 双源确认);500吨2025年营收325.97万元 + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述) + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'500吨已投产·M9方案7月小批量供货·2500吨2027Q1', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收1.52亿、归母0.02亿、毛利率25.26%</mark>(2026-04-15季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 362.12倍(3年分位27.31%,asOf:2026-06-21)</mark>。已通过台光/生益/联茂M9方案认证,规划总产能2500吨·H2放量 ⚠️口径待统一:盘锦500吨已投产 vs position 2500吨,当前 vs 规划混淆',
  ...
  },
  {
    ...
    stocks: [
      ...
      { rank:5, name:'中一科技', code:'301150', position:'高性能电子铜箔·HVLP4在研 + Phase 9 PCB 短板补充:🟢primary(中一科技 2025 年报) + Phase 9 PCB 短板补充:🟢primary(中一科技 2025 年报)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'锂电主业70%·HVLP4在研·Q1净利+2297%·台资试样', logic:'<mark class="updated">2026Q1营收17.97亿+43.94%、归母7084.03万+2297.11%、毛利率8.91%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 估值待更新(2026-Q1 扭亏后 EPS 正常化,asOf 2026-06-XX 待核)。锂电主业70%+电子电路铜箔30%·HVLP1-3已量产+HVLP4在研(国内第三梯队)',
        ...
        dims6Note:'🟢 锂电主业70%+电子电路铜箔30%·HVLP1-3已量产+HVLP4在研(国内第三梯队)·Q1净利0.71亿+2297.11%(扭亏);⚠️代码混淆修复(688234→301150)·原数据为天岳先进(碳化硅衬底)误录入·broker 双源已验证(兴业+长江)·§6.7 留痕' }
    ]
  },
  {
