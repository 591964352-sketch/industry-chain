  ...
  segments: [
    ...
    },
    {
      ...
      stocks: [
        ...
        { name:'超华科技', code:'002288', q1:false, q1note:'铜箔领域国内市占率不足10%,PCB领域排名靠后,非供给寡头(⚠️仅media源,无primary/broker·停牌无新公告)', q2:true, q2note:'常规产线满负荷运转,订单排至2026年三季度,HVLP铜箔已通过头部客户认证并批量出货', q3:false, q3note:'铜箔和PCB产品替代品充足,高端产品技术壁垒低于铜冠铜箔等龙头', q4:true, q4note:'跟国内AI服务器大厂绑定得比较深,产品覆盖高精度电子铜箔、高频附铜板、特种基材', hits:2, strength:'★☆☆' },
    ...
    },
    {
      ...
      stocks: [
        ...
        { name:'兴森科技', code:'002436', q1:false, q1note:'全球高端FCBGA(AI GPU基板)75%市场被日本Ibiden、台湾欣兴/南电/景硕垄断,大陆国产化率不足5%;兴森是国内唯一量产ABF/FCBGA的企业,但市占率仍低(P9 v1 豆包核实:⚠️仅media源,无broker)', q2:true, q2note:'ABF载板供需缺口2026–2028年持续扩大:2026下半年缺10%、2027缺21%、2028缺42%;ABF载板每季度涨价5–10%,广州基地一期已于2026年一季度正式量产,月产能3.6万片', q3:true, q3note:'内资唯一双载板量产平台:BT存储载板+ABF FCBGA算力载板双路线打通,国内同业难以复制,是国内稀缺的兼具BT与ABF/FCBGA封装基板产能的龙头企业', q4:true, q4note:'深度绑定华为昇腾AI芯片封装基板供应链,作为核心供应商份额预计占60%到70%左右,昇腾系列放量的订单确定性强', hits:3, strength:'★★☆' },
