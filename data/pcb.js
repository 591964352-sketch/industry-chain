...
CHAINS.pcb.segments = [
  {
    ...
    stocks: [
      ...
      { rank:5, name:'超华科技', code:'002288', position:'中端覆铜板+铜箔一体化·铜箔营收占比30%', barrier:'中', tier:'primary', valAsOf:'2024-11-13', src:'②待补(akshare无2026Q1数据)', trend:'down', trendNote:'中端CCL·AI纯度低·PE-TTM失真', logic:'②待补(akshare无2026Q1数据,最新一期为2024Q3亏损期,2024-11-13披露)。中端覆铜板+铜箔,AI纯度低,5G/汽车转型中;PE-TTM 失真(2024-08-18起持续负值,亏损期)',
        dims6:[{key:'durability',score:2,trend:'down',tier:'estimate',reason:'中端 CCL+铜箔一体化,AI 纯度低,5G/汽车转型中;最新财报停 2024Q3 亏损期,趋势向下(行业承压) → 2'},{key:'visibility',score:2,trend:'down',tier:'estimate',reason:'②待补(akshare 无 2026Q1 数据,2024Q3 亏损),业绩可见度极弱,趋势向下(失真期) → 2'},{key:'policy',score:2,trend:'flat',tier:'estimate',reason:'中端 CCL 无政策顺风,转型中政策驱动有限 → 2'},{key:'supply',score:2,trend:'flat',tier:'estimate',reason:'中端供给充足,趋势走平(竞争充分) → 2'},{key:'valuation',score:2,trend:'flat',tier:'estimate',reason:'PE-TTM 失真(2024-08-18 起持续负值,亏损期);②待补,趋势走平(无法计算) → 2'},{key:'barrier',score:2,trend:'flat',tier:'estimate',reason:'中端 CCL+铜箔一体化,但 AI 高端无突破,壁垒中等偏下 → 2'}],
