...
CHAINS.pcb.segments = [
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'沪电股份', code:'002463', position:'（待补）', barrier:'高', tier:'primary', valAsOf:'2026-06-13',
      ...
      { rank:2, name:'胜宏科技', code:'300476', position:'（待补）', barrier:'高', tier:'primary', valAsOf:'2026-06-13',
        dims6:[{key:'durability',score:5,trend:'up'},{key:'visibility',score:5,trend:'up'},{key:'policy',score:3,trend:'flat'},{key:'supply',score:4,trend:'up'},{key:'valuation',score:2,trend:'down'},{key:'barrier',score:4,trend:'flat'}],
        logic:'（待补）',
