...
CHAINS.pcb = {
  ...
  meta: { sector:'中游', tier:'核心', status:'active(R3-18 src真URL补全启动·2026-06-23·34只segments + 30只fourQ + 10只midstream(实际独立stock 38只含跨视图重复)·90.9% fourQ覆盖率(30/33 segments内stock)·健康度4.1/5·71处⚠️标注(46行/超30处目标+41处)·28/34 stock src为akshare(违反§6.4待补)·tier字段100% primary待规范化·CLAUDE.md §6+§6.9+§6.10+§6.11 + SKILL.md §6§7+三重验证机制 + refresh-sop.md §6.5+§9 治理纪律已固化)', updatedAt:'2026-06-22', ltFit:null },
  ...
  prosperity: {
    dims: [
      ...
      { key:'valuation', name:'估值性价比', score:1, trend:'down',
        reason:'⚠️本轮最大扣分项：3 只核心卡口估值口径须**分别看待**，不可拿一个 TTM 拍整体——具体 PE-TTM/PE 分位/距前高回落幅度见 auto.valuations（3 只 code·pe_ttm+pePercentile+fromHigh 实时读取·asOf 以 PCB_AUTO._meta.asOf 为准）。综合 1 分=门控触发，挡掉"业绩爆表+泡沫"陷阱。下钻见各卡口 valuation。',
        evidence:'roll-up 自 chokePoints[].valuation / 由 auto 层实时计算', flag:'🟢', rollupFrom:'chokePoints[].valuation.pePercentile', tier:'estimate', src:'★ commit 4.21：估值 dim 改为动态读取 auto 层·3 卡口 PE-TTM/PE 分位/距前高回落幅度 由 PCB_AUTO.valuations 实时计算·不再写死旧值', asOf:'2026-06-24' },
  ...
  cyclePosition: { stage:'boom', label:'繁荣中后期', reason:'🟢 AI 算力超级上行周期，需求强劲但估值已高，2027 年上游集中扩产可能形成供给拐点（AI初版，周一定时任务会覆盖）', watchSignals:['英伟达资本开支指引（季度财报披露）','上游集中扩产公告（M9 树脂/HVLP 铜箔新产能落地）','M9 材料缺口率变化（缺口收窄 = 见顶信号）'] },
  plainIntro: {
...
CHAINS.pcb.segments = [
  {
    ...
    stocks: [
      { rank:1, name:'生益科技', code:'600183', position:'全球高端覆铜板第一梯队·M9等级大陆唯一进入英伟达供应链(与台光/松下并列三大供应商)·全球市占14-15% + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 英伟达供应链公告) + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 英伟达供应链公告)', barrier:'极高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M9 GB200/GB300批量·AMD MI300·谷歌TPU 78层', logic:'<mark class="updated">2026Q1营收81.41亿+45%，净利11.58亿+105%</mark>。M8 已批量应用、M9 已取得 N 客户（broker 口径隐指英伟达）认证（v3 豆包联网核实：cninfo 2025 年报 + 2026-05-08 业绩说明会 + 招商证券研报）；M9 CCL 已批量供货英伟达供应链，全球市占14-15%，Q1毛利率28.10%;PE-TTM 113.69倍(3年分位97.42%,asOf:2026-06-21) ⚠️口径待统一:position M9市占30-40% vs logic全球市占14-15%——口径不同(细分品类M9 vs 整体CCL) ⚠️待核≥2源:M9大陆唯一表述(国信/东方财富财富号 ≥2源已核实✅)',
      ...
      { rank:2, name:'华正新材', code:'603186', position:'华为昇腾CCL核心供·CBF积层膜对标味之素ABF + Phase 9 PCB 短板补充:⚪media(东方财富/雪球 + 公司公告) + Phase 9 PCB 短板补充:⚪media(东方财富/雪球 + 公司公告)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'CBF国产唯一·海思/中芯/长电/通富·ABF中试送样', logic:'<mark class="updated">2026Q1营收12.34亿、归母0.31亿、毛利率12.02%</mark>(2026-04-22季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 129.08倍(3年分位88.76%,asOf:2026-06-21)</mark>。AI服务器用高等级CCL+CBF膜切入华为/中芯,国产替代直接受益',
      ...
      { rank:3, name:'南亚新材', code:'603519', position:'刚性CCL全球前10·大陆第三(Prismark·2023年度)·M8量产M9测试中 + Phase 9 PCB 短板补充:🔵broker(Prismark 2023 年度报告) + Phase 9 PCB 短板补充:🔵broker(Prismark 2023 年度报告)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M7已量产·M8验证中·M9在研', logic:'<mark class="updated">2026Q1营收3.95亿、归母0.34亿、毛利率15.71%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 25.32倍(3年分位75.91%,asOf:2026-06-21)。高速材料从M8→M9追赶中,AI服务器订单加速放量',
      ...
      { rank:4, name:'金安国纪', code:'002636', position:'国内龙头·全球CCL第7 + Phase 9 PCB 短板补充:🔵broker(Prismark 2026) + Phase 9 PCB 短板补充:🔵broker(Prismark 2026)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'M7已量产·M8在研·Q1+763.91%', logic:'<mark class="updated">2026Q1营收12.60亿、归母2.02亿、毛利率26.44%</mark>(2026-04-29季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 158.61倍(3年分位42.05%,asOf:2026-06-21)。涨价期情绪标杆,中低端CCL为主,AI暴露弱',
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'东材科技', code:'601208', position:'全球唯二M9碳氢树脂认证·国内唯一 + Phase 9 PCB 短板补充:🔵broker(M9 认证公告 + CPCA 2026) + Phase 9 PCB 短板补充:🔵broker(M9 认证公告 + CPCA 2026)', barrier:'极高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M9 GB300量产·M10验证中·台光独家', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收14.44亿、归母净利1.87亿+103%、毛利率17.13%</mark>(2026-04-23季报,tier:primary,src:akshare/新浪财经(基于公司季报));高速电子树脂营收2.58亿+131%;PE-TTM 198.72倍(3年分位63.47%,asOf:2026-06-21)。台光独供2-3年排他协议。眉山3500吨<mark class="updated">2026年6月30日投料试产(提前至Q2末)</mark>。高速电子级碳氢树脂供应商·价格/毛利率数据待2025年报树脂业务分项披露后核实 ⚠️口径待统一:价格80-120万元/吨+毛利50%+,协会极少披露价格区间 ⚠️单源待核:价格80-120万元/吨+毛利50%+(协会极少披露) ⚠️asOf待核:眉山3500吨 2026/6/30 投料试产 应标具体披露日(迫近 2026-06-16)',
      ...
      { rank:2, name:'圣泉集团', code:'605589', position:'PPO国内唯一量产·全球第四 ✅ R3-11 豆包反核实:酚醛树脂国产市占70%（国泰海通 2025-09-30 + 国信证券 2026-04-27 双 broker 确认）,全球产能第一（65万吨）,成本较中小厂商低15%-20% + Phase 9 PCB 短板补充:⚪media(东方财富 2026 + 公司公告) + Phase 9 PCB 短板补充:⚪media(东方财富 2026 + 公司公告)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'PPO M8已量产·碳氢已批量·1500吨Q4投产', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收26.71亿、归母1.77亿、毛利率26.25%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 60.48倍(3年分位99.87%,asOf:2026-06-20)。PPO国内规模化量产领先(现有产能1300-1800吨/年,2026Q3新增2000吨/年项目投产)·碳氢树脂2026Q4投产1500吨,向上突破 ⚠️待核≥2源:"PPO国内唯一量产"未找到协会/研报≥2源支撑 ⚠️单源待核:"国产市占70%"未找到来源支撑,建议改为"待核"或删除',
      ...
      { rank:3, name:'世名科技', code:'300522', position:'盘锦500吨已投产·M9方案已认证 ✅ R3-11 豆包反核实:500吨已投产+2500吨为2026年扩产目标,无混淆(东方证券 2026-06-17 + 公司公告 2026-06-17 双源确认);500吨2025年营收325.97万元 + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述) + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'500吨已投产·M9方案7月小批量供货·2500吨2027Q1', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收1.52亿、归母0.02亿、毛利率25.26%</mark>(2026-04-15季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 362.12倍(3年分位27.31%,asOf:2026-06-21)</mark>。已通过台光/生益/联茂M9方案认证,规划总产能2500吨·H2放量 ⚠️口径待统一:盘锦500吨已投产 vs position 2500吨,当前 vs 规划混淆',
      ...
      { rank:4, name:'宏昌电子', code:'603002', position:'环氧树脂龙头·GBF增层膜送样 + Phase 9 PCB 短板补充:🔵broker(中国电子材料协会 2026 + 公司公告) + Phase 9 PCB 短板补充:🔵broker(中国电子材料协会 2026 + 公司公告)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'台积电低Alpha·珠海三期8万吨·52项专利·Q1+60%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收9.89亿、归母0.005亿、毛利率4.87%</mark>(2026-04-29季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 910.07倍(3年分位58.20%,asOf:2026-06-21)</mark>。GBF增层膜送样台积电/长电,但环氧树脂壁垒低→非卡口;Q1毛利率仅4.87%,业绩弹性极弱',
        ...
        dims6Note:'🟢 台积电低 Alpha 环氧 2025-12 认证(国内唯一量产打破日企垄断)+珠海三期 8 万吨 2026-01 试生产+52 项发明专利;Q1毛利率4.87%极低/净利0.005亿扭亏边缘;PE-TTM 813.95倍/3年分位99.84%(asOf 2026-06-16)——估值严重透支;⚠️环氧树脂属电子树脂段(本段)·IC载板段 ABF 膜不纳入(品类混淆标注 SKILL.md §7.2)' },
      { rank:5, name:'彤程新材', code:'603650', position:'电子级酚醛树脂·对标SABIC PPO + Phase 9 PCB 短板补充:🔵broker(中国电子材料协会 + 公司公告) + Phase 9 PCB 短板补充:🔵broker(中国电子材料协会 + 公司公告)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'电子级酚醛+中芯/长江存储·PPO在研', logic:'<mark class="updated">2026Q1营收10.49亿、归母1.82亿、毛利率22.21%</mark>(2026-04-18季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 69.52倍(3年分位49.02%,asOf:2026-06-21)。电子级酚醛稳定供应·PPO对标SABIC·AI暴露弱',
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'菲利华', code:'300395', position:'Q布业务处认证阶段(2025年收入9,837.37万元/占总营收4.88%)·石英砂环节中试阶段(非独家,石英股份等亦布局)·制品环节技术领先 + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 菲利华 2025 年报) + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 菲利华 2025 年报)', barrier:'极高', tier:'primary', valAsOf:'2026-06-22', src:'2026Q1/2025年报', trend:'up', trendNote:'英伟达全额预购2026年600-700万米Q布', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收6.22亿+53%，净利1.44亿+37%</mark>。已通过英伟达/台积电/台光/生益全链路认证。台光锁定500-700万米(C7 v1 豆包核实:primary 投资者关系活动 + 中泰证券 双源,台光锁定为行业传闻,2027目标为公司规划;P7 broker双源验证:中泰 2026-05-11 + 中信建投 2026-06-02)。全球缺口>40%。毛利率55-65%。2027目标2000万米/年(C7 v1 豆包核实:primary 投资者关系活动 + 中泰证券 双源);PE-TTM 148.12倍(3年分位94.77%,asOf:2026-06-21) ⚠️口径待统一:4数字密集(缺口>40%+毛利55-65%+台光锁500-700万米+2027目标2000万米/年),需厘清各自时间口径 ⚠️ R3-11 豆包反核实维持单源待核:仅找到国海证券 2026-04-25 1个 broker 源,台光锁单数据未获公司官方公告确认,2026 年实际出货量预计低于目标 ⚠️单源待核维持;⚠️已发现矛盾证据:原"国产唯一全产业链"表述不成立(石英砂环节中试阶段+石英股份同样布局),position已修订为分环节表述',
        ...
        dims6Note:'🟢 英伟达Rubin/M9认证(2024-12 broker单源·中泰·⚠️单源待核)+台光/生益CCL厂认证(沿用R3-9 P7 broker双源·中泰+中信建投);⚠️Q布业务仍处认证阶段(2025年收入9,837.37万元/占总营收4.88%·非已量产);⚠️R3-11国海证券单源风险提示保留:2026实际出货量预计低于目标;Q布全球缺口>40%(broker双源·Prismark+中泰);Q1营收6.22亿+53%/净利1.44亿+37%;Q布毛利55-65%(broker双源·中泰+华泰);PE-TTM 148.12倍/3年分位94.77%(asOf 2026-06-21)——估值历史极贵' },
      { rank:2, name:'宏和科技', code:'603256', position:'4μm极薄布全球唯一量产·全球市占~50% + Phase 9 PCB 短板补充:🔵broker(CPCA 2026 + 宏和年报) + Phase 9 PCB 短板补充:🔵broker(CPCA 2026 + 宏和年报)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'4μm GB300全球唯一·黄石10亿米2027Q2·3μm验证中', hits:3, strength:'★★☆', logic:'<mark class="updated">2026Q1营收4.42亿、归母1.40亿、毛利率55.65%</mark>(2026-04-17季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 749.19倍(3年分位38.44%,asOf:2026-06-21)。超薄电子布全球市占~50%。但非AI最核心瓶颈→降级',
        ...
        dims6Note:'🟢 4μm GB300全球唯一(2024-12 broker双源·东吴+国信)/台积电3nm 2025-03 broker双源(东吴+国泰君安)/AMD MI300 2026-Q1 单源;黄石10亿米/年 2026-Q1 签约(primary);Q1毛利率55.65%极高;PE-TTM 749.19倍/3年分位38.44%(asOf 2026-06-21)——估值绝对值严重透支' },
      { rank:3, name:'中材科技', code:'002080', position:'国内Low Dk市占35%·石英布独供胜宏GB300 + Phase 9 PCB 短板补充:🟢primary(中材科技 2025 年报) + Phase 9 PCB 短板补充:🟢primary(中材科技 2025 年报)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'石英布胜宏独家·GB300认证·Low-Dk二代已批量·华为昇腾', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收68.54亿、归母5.07亿、毛利率20.94%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 68.86倍(3年分位72.25%,asOf:2026-06-21)。Q布占特种纤维布约20-30%,特种纤维布占公司总营收2.08%(C8 v1 豆包核实:primary 中材公告 + 华泰证券 双源;P7 broker双源验证:华泰 2026-06-17 + 中泰 2026-04-28);非前三寡头·主业玻纤稳',
        ...
        dims6Note:'🟢 石英布胜宏独家(2024-12 broker双源·长江+交银·1.5万米/月占胜宏Q布100%)/T-glass GB200 2026-Q1 单源(中信)/Low-Dk华为昇腾 2025-Q2 单源(长江);Q布月产能5.5万米(单源·中信);Low-Dk良率90%+毛利35-40%(broker双源·长江+中信);Q布占比特种纤维布20-30%(broker双源·沿用R3-9 P7);Q1净利5.07亿;PE-TTM 68.86倍/3年分位72.25%(asOf 2026-06-21)——估值偏高' },
      { rank:4, name:'中国巨石', code:'600176', position:'电子纱产能国内第一(市占25%)·全球电子玻纤市占~23%(淮安扩产后升至~28%)·全球玻纤龙头 + Phase 9 PCB 短板补充:🔵broker(中国玻纤工业协会 2025 + 年报) + Phase 9 PCB 短板补充:🔵broker(中国玻纤工业协会 2025 + 年报)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'E-glass生益/台光·淮安3.9亿米·Low-Dk研发·AI纯度低', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收52.82亿、归母12.67亿、毛利率39.64%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 56.03倍(3年分位60.94%,asOf:2026-06-21)。全球玻纤龙头,但非Q布寡头·AI纯度低',
        ...
        dims6Note:'🟢 全球玻纤龙头(总产能13.5亿米·2026 broker双源·Prismark+中金)+淮安3.9亿米电子布 2026-03 点火(primary)+44.31亿扩产 2026-05(primary);Low-Dk生益/南亚 2024-12 broker双源(中金+华泰)/超薄布台光 2025-Q2 单源(中金);⚠️2026-Q1 未通过英伟达/台积电高端认证(primary·AI纯度低·非Q布寡头·诚实保留);Low-Dk良率85-90%毛利30-35%(单源·华泰);Q1净利12.67亿/毛利率39.64%;PE-TTM 56.03倍/3年分位60.94%(asOf 2026-06-21)——估值偏高' },
      { rank:5, name:'山东玻纤', code:'605006', position:'电子布老牌·ECR玻纤纱 + Phase 9 PCB 短板补充:🆪estimate(山东玻纤 2025 年报) + Phase 9 PCB 短板补充:🆪estimate(山东玻纤 2025 年报)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'down', trendNote:'E-glass中端PCB·非Q布·市占5%·Q1+20%', logic:'<mark class="updated">2026Q1营收8.45亿、归母0.10亿、毛利率14.48%</mark>(2026-04-30季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 失真(-1246.93倍,2026-06-16,亏损/微利期)。中端电子布为主·非Q布寡头·AI暴露极弱',
        ...
        dims6Note:'🟢 E-glass中端PCB厂(金安国纪/超声电子 2024-12 broker双源·天风+海通);⚠️2024-Q4至2026-Q2 未获英伟达/台积电认证(primary·无Q布业务·AI暴露极弱);中端市占率约5%(2026 broker双源·天风+海通);超薄布深南电路 2025-Q2 单源(天风);无新产线无技改(primary);Q1净利0.10亿微利/毛利率14.48%;PE-TTM失真(-1246.93倍,微利期估值失真)' }
    ]
  },
  {
    ...
    stocks: [
      { rank:1, name:'铜冠铜箔', code:'301217', position:'国内唯一HVLP1-4全系列量产·2027市占预期42% ⚠️待核≥2源:日韩四强垄断85%+(Prismark) + Phase 9 PCB 短板补充:🟢primary(铜冠铜箔 2025 年报 + Prismark) + Phase 9 PCB 短板补充:🟢primary(铜冠铜箔 2025 年报 + Prismark)', barrier:'极高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'GB200/GB300 HVLP4量产·深南长期协议·HVLP5样品', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收18.42亿、归母1.06亿、毛利率8.79%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 1009.48倍(3年分位92.08%,asOf:2026-06-21)</mark>。<mark class="updated">锁定10台三船MSP-8000表面处理机(全球70%),产能确定性最强(C1 v1 豆包核实:primary 投资者关系活动 + 中信证券 + 中泰证券 三源;P7 broker双源验证:华泰 2026-05-20 + 中信 2026-05-17)</mark>。2026目标500吨/月。日韩四强垄断85%+。设备交期18-24月(C4 v1 豆包核实:primary 投资者关系活动 + 海通证券 双源)。2027年HVLP铜箔市占率目标40%(券商测算)。已实现HVLP4规模化量产 ⚠️口径待统一:2027中国1厂42% vs 日韩合计85%+,两口径统计基础不同 ⚠️→✅ R3-11 豆包反核实:锁定数量从10台订正为7台(天风证券 2026-04-05 + 杰富瑞 2026-06-18 双 broker 确认);2026目标500吨/月+2027高端HVLP铜箔市占42%(42%为高端HVLP口径,非整体铜箔市场);设备交期18-24月维持 ⚠️单源待核解除',
        ...
        dims6Note:'🟢 HVLP4 GB200/GB300批量供货(2025-Q2 broker双源·华泰+中信)+HVLP5送样(2025-Q3 primary)+Google/AWS(2026-Q1 broker双源)+深南长期协议(2026-Q2 primary);锁定7台三船MSP-8000-Pro(沿用R3-11 broker双源);池州1万吨2026-Q4投产(primary)/HVLP4良率75%(broker双源);Q1营收18.42亿/净利1.06亿/毛利率8.79%;⚠️日韩85%+(Prismark单源)+HVLP5客户认证时间未查到' },
      { rank:2, name:'德福科技', code:'301511', position:'进入英伟达供应链·电子电路铜箔年产能5万吨可柔性切换·HVLP4已在部分客户小规模放量(2025年报)·HVLP5完成样品认证 + Phase 9 PCB 短板补充:🟢primary(德福科技 2025 年报) + Phase 9 PCB 短板补充:🟢primary(德福科技 2025 年报)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'全球第二HVLP4出货·HVLP5样品认证完成⚠️单源待核(2026-06-10互动易)·3μm载体铜箔·AMD MI300', hits:3, strength:'★★☆', logic:'<mark class="updated">2026Q1营收43.38亿、归母1.47亿、毛利率9.11%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 419.87倍(3年分位85.32%,asOf:2026-06-21)。2025年报:电子电路铜箔年产能5万吨可柔性切换。HVLP4已在部分客户小规模放量(较"验证中"更进一步)·HVLP5完成样品认证。机构关注度高→降级',
        ...
        dims6Note:'🟢 全球第二家/国内唯一HVLP4小批量出货(2025-Q4 broker双源·中泰+招商)+HVLP5样品认证(primary 2026-03-15)+英伟达供应链通过卢森堡CFL(broker双源);5万吨可柔性切换+2027-2028新增5万吨(broker双源);1.6T光模块载体铜箔量产(primary 2026-05-15);Q1营收43.38亿/净利1.47亿/毛利率9.11%;⚠️HVLP4单吨20-25万元(中泰单源)+良率/卢森堡产能利用率未查到+L4"卢森堡CFL"境外收购基地pcb.js无旧值' },
      { rank:3, name:'诺德股份', code:'600110', position:'6μm极薄铜箔量产·服务器铜箔市占>25%·2026Q1扭亏 + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 赛迪) + Phase 9 PCB 短板补充:🔵broker(Prismark 2026 + 赛迪)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'HVLP3量产·HVLP4验证中·6μm良率92%·Q1扭亏', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收25.43亿、归母0.40亿、毛利率11.71%</mark>(2026-04-23季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 失真(-123.02倍,2026-06-16,扭亏微利期)。服务器PCB用铜箔市占>25%,但HVLP4仍在认证',
        ...
        dims6Note:'🟢 HVLP3已小批量供货(2026-Q1 broker双源·东北+东方)+HVLP1-2台系/国内头部供应链(broker双源);HVLP4仍在认证(2024-Q4起送样 broker双源·国内第二梯队);6μm良率92%(broker双源);湖北黄石1万吨产线+3万吨高端规划(primary);Q1营收25.43亿/净利0.40亿同比+206.42%(扭亏);PE-TTM失真(-123.02倍·扭亏微利期);⚠️服务器铜箔市占25%(东北单源)+HVLP4认证完成时间/良率未查到' },
      { rank:4, name:'嘉元科技', code:'688388', position:'极薄铜箔4.5μm市占>50% + Phase 9 PCB 短板补充:🟢primary(嘉元科技 2025 年报) + Phase 9 PCB 短板补充:🟢primary(嘉元科技 2025 年报)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'2026Q1季报(2026-04-27)+新浪财经2026-04-29', trend:'up', trendNote:'A股第三HVLP4小批量·生益试样1亿·Q1+392.77%', hits:null, strength:null, logic:'2026Q1归母净利润1.21亿元(+392.77%),扣非净利1.09亿元(+1208%),营收34.45亿元(+73.94%)(2026-04-27季报)·锂电铜箔转产HVLP;PE-TTM 203.38倍(3年分位21.85%,asOf:2026-06-21)',
        ...
        dims6Note:'🟢 A股第三家HVLP4小批量供货(2026-Q2 broker双源·麦高+国信)+HVLP3样品认证(broker双源);4.5μm极薄铜箔全球市占>50%(broker双源)·全球第一;锂电转HVLP4技术突破(broker双源);龙南3.5万吨高端产能2027投产(broker双源);Q1营收34.45亿+73.94%/净利1.21亿+392.77%/毛利率12.5%(primary);⚠️锂电转HVLP技术突破(麦高单源)+HVLP4良率/客户认证完成时间未查到' },
      { rank:5, name:'中一科技', code:'301150', position:'高性能电子铜箔·HVLP4在研 + Phase 9 PCB 短板补充:🟢primary(中一科技 2025 年报) + Phase 9 PCB 短板补充:🟢primary(中一科技 2025 年报)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'锂电主业70%·HVLP4在研·Q1净利+2297%·台资试样', logic:'<mark class="updated">2026Q1营收17.97亿+43.94%、归母7084.03万+2297.11%、毛利率8.91%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 估值待更新(2026-Q1 扭亏后 EPS 正常化,asOf 2026-06-XX 待核)。锂电主业70%+电子电路铜箔30%·HVLP1-3已量产+HVLP4在研(国内第三梯队)',
        dims6:[{key:'durability',score:3,trend:'flat',tier:'estimate',reason:'锂电主业70%+电子电路铜箔30%,HVLP1-3已量产+HVLP4在研(国内第三梯队);AI 暴露弱,趋势走平 → 3'},{key:'visibility',score:3,trend:'flat',tier:'estimate',reason:'26Q1 营收 17.97 亿+43.94%,归母 0.71 亿+2297.11%(扭亏),毛利率 8.91%;HVLP1-3 已量产+1 万吨高端电子电路铜箔产能调试中,趋势走平 → 3'},{key:'policy',score:3,trend:'flat',tier:'estimate',reason:'国产替代政策中性,趋势走平 → 3'},{key:'supply',score:3,trend:'flat',tier:'estimate',reason:'锂电主业稳定+电子电路铜箔产能扩张中(1 万吨调试);HVLP4 在研未量产,趋势走平(竞争充分) → 3'},{key:'valuation',score:3,trend:'flat',tier:'estimate',reason:'PE-TTM 估值待更新(2026-Q1 扭亏后 EPS 正常化,asOf 2026-06-XX 待核);趋势走平 → 3'},{key:'barrier',score:2,trend:'flat',tier:'estimate',reason:'HVLP4 在研(国内第三梯队),壁垒中等偏下;非 HVLP4 主卡口,壁垒待兑现 → 2'}],
        dims6Note:'🟢 锂电主业70%+电子电路铜箔30%·HVLP1-3已量产+HVLP4在研(国内第三梯队)·Q1净利0.71亿+2297.11%(扭亏);代码混淆修复(688234→301150)·原数据为天岳先进(碳化硅衬底)误录入·broker 双源已验证(兴业+长江)·§6.7 留痕' }
    ]
  },
  {
    ...
    stocks: [
      { rank:1, name:'深南电路', code:'002916', position:'国内唯一ABF载板批量交付·大陆内资ABF市占~63%·全球PCB营收前10', barrier:'极高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'20层ABF GB200量产·28层Rubin批量·M10样品⚠️单源待核(2026-05-26互动易)·英伟达+AMD双AI·谷歌TPU4 FC-BGA·Q1+86%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收65.96亿、归母8.50亿、毛利率29.17%</mark>(2026-04-24季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 85.05倍(3年分位87.92%,asOf:2026-06-21)</mark>。FC-BGA 22 层及以下产品已量产，24 层及以上产品技术研发及打样中（公司公告 2026-03-12 投资者关系活动 + 2025 年报 cninfo 巨潮），良率数据未披露（v3 豆包联网核实）；广州60亿投资2亿颗FC-BGA/年。Q1净利+73%。封装基板营收41.48亿+30.8%。2026-06-13 公告拟募资36亿元建设无锡AI算力电子电路产品项目(核心产品为AI服务器PCB);2026-06-16 调研:泰国工厂+南通四期项目产能稳步爬坡,AI服务器PCB订单饱满(P3 v1 豆包联网核实)',
        ...
        dims6Note:'🟢 20层ABF GB200批量+AMD MI300认证+Rubin 28层(2025-Q1/2026-Q1 broker双源·华泰+中信+天风+杰富瑞);国内唯一批量交付+国内唯一双AI巨头认证(英伟达+AMD);广州月产5万片2025年底/良率90%(primary+broker双源);Q1营收65.96亿+73%/净利8.50亿+73%;⚠️IBIDEN/欣兴/南电/景硕垄断75%+(Prismark单源)+国内"唯一"措辞需核实+良率数据broker单源待补强' },
      { rank:2, name:'兴森科技', code:'002436', position:'ABF载板国产化追赶者·HBM级ABF唯一 ⚠️待核≥2源:HBM级ABF唯一(深南也做ABF,需厘清"HBM级"限定) + Phase 9 PCB 短板补充:⚪media(深南电路互动易 + 媒体) + Phase 9 PCB 短板补充:⚪media(深南电路互动易 + 媒体)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'FCBGA Rubin 200批量供货·双AI巨头·台积电BT载板验证·寒武纪壁仞量产·Q1+157%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收18.18亿、归母0.19亿、毛利率19.17%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 613.12倍(3年分位79.10%,asOf:2026-06-21)</mark>。华为昇腾认证通过。华为哈勃入股。量产爬坡缓慢',
        ...
        dims6Note:'🟢 FCBGA Rubin 200认证(2025-Q2 broker双源·中泰+招商)+国内唯一双AI巨头(英伟达+AMD)+华为哈勃入股(2025-09-08 primary)+台积电认证(2026-Q1 broker双源·中泰+杰富瑞)+HBM级ABF验证中;珠海+广州月产能2027年4万片(broker双源)+mSAP线宽3μm/3μm;Q1营收18.18亿/净利0.19亿同比+120%(扭亏);⚠️国产化替代空间800亿元(中泰单源)+HBM级ABF客户认证时间未查到' },
      { rank:3, name:'华正新材', code:'603186', position:'CBF积层膜对标味之素ABF', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'CBF国产唯一量产·海思中芯长电通富·ABF基材样品⚠️单源待核(2026-05-22项目公告)·深南兴森试样·临安300万㎡+二期600万㎡Q4·Q1毛利12%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收12.34亿、归母0.31亿、毛利率12.02%</mark>(2026-04-22季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 129.08倍(3年分位98.53%,asOf:2026-06-20)</mark>。CBF膜切入华为昇腾供应链,中芯国际验证中',
        ...
        dims6Note:'🟢 CBF膜国产唯一量产(2025-Q1海思认证批量供货+2025-Q3中芯国际认证 primary)+长电/通富月供50吨(2026-Q1 broker双源·东北+民生)+ABF膜中试送样(2026-Q1 broker双源);CBF年产能1000吨/良率85%(primary+broker双源)+ABF中试100吨/年+2027年量产500吨;Q1营收12.34亿/毛利率12.02%偏低/净利0.31亿;⚠️味之素垄断ABF膜90%+(Prismark单源)+L4"通富/海思"封装设计厂pcb.js无旧值' },
      { rank:4, name:'联瑞新材', code:'688300', position:'亚微米球形硅微粉·球形硅微粉国内市占~40%', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'球形硅微粉·揖斐电+深南兴森·长电·M9/M10纳米样品·AI暴露18%·Rubin低α未启动·Q1+32%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收2.94亿、归母0.72亿、毛利率40.02%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 216.80倍(3年分位89.76%,asOf:2026-06-21)</mark>。ABF膜关键填料,进入头部供应链·主业硅微粉稳定',
        ...
        dims6Note:'🟢 球形硅微粉通过日本揖斐电(2024-Q4 broker双源·麦高+国信)+超细0.3μm台光认证(2025-Q2 primary)+纳米0.1μm送样(2026-Q1 broker双源);国内第一15%市占(broker双源)+年产能8万吨/高端30%+火焰法核心技术;Q1营收2.94亿/净利0.72亿/毛利率40.02%极强;⚠️龙森/联志垄断60%+(Prismark单源)+L4"揖斐电"日本ABF载板厂pcb.js无旧值;⚠️AI纯度弱·IC载板段辅助材料·trend维持flat' },
      { rank:5, name:'博敏电子', code:'603936', position:'PCB+汽车切入ABF + Phase 9 PCB 短板补充:⚪media(公司公告 + 媒体) + Phase 9 PCB 短板补充:⚪media(公司公告 + 媒体)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'down', trendNote:'ABF规模<1%·HBM在研·Q1亏损·Switch/正交背板·AI载板落后', logic:'<mark class="updated">2026Q1营收8.18亿、归母-0.11亿(亏损)、毛利率15.50%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 失真(-518.62倍,2026-06-16,亏损期估值失真)。PCB老牌厂商切入ABF,量产规模小·AI暴露弱',
        ...
        dims6Note:'🟢 ABF规模<1%(broker双源·兴业+长江)·12层ABF样品认证+14层ABF通过(2025-Q4 primary)+HBM级ABF在研(2026-Q2 broker双源);Switch板20-25%+正交背板25%+(2026-Q2 primary·R3-13品类混淆修正);ABF月产能0.5万片/良率75-80%/线宽5μm/5μm;Q1营收8.18亿/归母-0.11亿亏损/毛利率15.50%;trend维持down·ABF切入失败+HBM未启动' }
    ]
  },
  {
    ...
    stocks: [
      { rank:1, name:'鼎泰高科', code:'301377', position:'PCB钻针全球第一(2024年市占26.8%/2025H1进一步提升至28.9%,Frost&Sullivan数据) ⚠️口径待统一:钻针全球第一26.8% vs 同段金洲精工20.8% 全球第二,合计47.6%留52%+给其他 ⚠️时序已更新:原26.5%是2023年Prismark旧数据,本次更新为最新 + Phase 9 PCB 短板补充:🔵broker(Frost & Sullivan 2025) + Phase 9 PCB 短板补充:🔵broker(Frost & Sullivan 2025)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'钻针全球第一28.9%·0.01mm沪电深南·80倍径验证·HBM样品·Q1+96%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收8.14亿、归母2.61亿、毛利率53.25%</mark>(2026-04-16季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 397.10倍(3年分位82.30%,asOf:2026-06-21)。2025年报(2026-03-26):归母净利4.34亿元(+91.1%),毛利率42.34%(+6.54pct),扣非净利4.09亿元(+102.5%)·AI高多层板钻针耗量激增 ⚠️口径待统一:同position 26.8% + 20.8% 合计47.6% 张力 ⚠️→✅ R3-11 豆包反核实:AI服务器PCB钻孔数为普通服务器的5-10倍,单台钻孔量从10万→50万+孔(东北证券 2026-04-10 + 国海证券 2026-05-24 双 broker 源确认);M9基材使钻针寿命从3000孔降至100-200孔,形成供需共振 ⚠️单源待核解除',
        ...
        dims6Note:'🟢 钻针全球第一28.9%(2025H1 broker单源·弗若斯特沙利文)+0.01mm超细径英伟达AI服务器认证(2025-Q1 broker双源·华泰+中信)+50倍长径比沪电深南认证(2025-Q3 primary)+80倍长径比验证中(2026-Q1 broker双源);AI服务器PCB钻孔数5-10倍(沿用R3-11 broker双源·中信+招商);CVD/PVD/Ta-C涂层国内唯一(broker双源);Q1营收8.14亿/净利2.61亿/毛利率53.25%;⚠️全球钻针28.9%(弗若斯特沙文单源)+80倍径长径比2处重复提取;⚠️HBM样品认证为2026-06-05新品公告单源待核' },
      { rank:2, name:'大族数控', code:'301200', position:'钻孔设备全球第二·AI高多层板设备市占40-50% + Phase 9 PCB 短板补充:🔵broker(Prismark + CPCA) + Phase 9 PCB 短板补充:🔵broker(Prismark + CPCA)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'钻孔国内70%·沪电胜宏认证·英伟达2亿订单·景旺鹏鼎·ABF激光样品·Q1+108%', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收19.55亿、归母3.23亿、毛利率33.12%</mark>(2026-04-21季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 159.93倍(3年分位70.11%,asOf:2026-06-21)。2025年报(2026-03-31):营业总收入57.73亿元(+72.68%),归母净利润8.24亿元(+173.68%),扣非净利8.21亿元(+290.92%)·AI高多层板设备市占40-50%',
        ...
        dims6Note:'🟢 钻孔设备国内70%市占(2025 broker双源·中泰+招商)+沪电/胜宏认证(2025-Q1/Q3 broker+primary)+英伟达AI服务器订单2亿(2026-Q1 broker双源·招商+东方)+2025净利8.24亿+173.68%/扣非+290.92%;新一代激光钻孔<25μm良率99%+速度提升50%;2026新增500台/年;Q1营收19.55亿/净利3.23亿;⚠️国内70%市占(中泰单源)+新一代激光钻孔机客户认证时间未查到' },
      { rank:3, name:'芯碁微装', code:'688630', position:'PCB直接成像设备全球市占率18.8%(2025年,收入口径,全球第一,领先第二名3.1pct)·全球唯一覆盖PCB/IC载板/先进封装/掩膜版四场景的企业(灼识咨询·港交所招股书) + Phase 9 PCB 短板补充:🔵broker(灼识咨询·港交所招股书) + Phase 9 PCB 短板补充:🔵broker(灼识咨询 港交所招股书)', barrier:'高', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'LDI全球第一18.8%·3-4μm胜宏·ABF载板深南量产·英伟达1.5亿·兴森华正新增·Q2批量交付', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收5.15亿、归母1.08亿、毛利率40.94%</mark>(2026-04-30季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 190.89倍(3年分位96.39%,asOf:2026-06-21)。2026年港交所招股书(灼识咨询):PCB直接成像设备2025年全球市占18.8%(收入口径,全球第一,领先第二名3.1pct)·全球唯一覆盖PCB/IC载板/先进封装/掩膜版四场景企业 ⚠️单源待核:原"3-4μm线宽+2026激光钻孔订单70-100台"未找到对应来源,本次整体替换为招股书数据',
        ...
        dims6Note:'🟢 LDI全球第一18.8%(2025 broker三源验证·灼识咨询港交所招股书·东北+民生+东方)+3-4μm胜宏认证(2025-Q1 broker双源)+ABF载板深南(2025-Q3 primary)+英伟达AI服务器LDI订单1.5亿(2026-Q1 broker双源);四场景覆盖(PCB/IC载板/先进封装/掩膜版);2μm级LDI验证中(2026-Q1 broker双源)+3-4μm良率99.5%+;Q1营收5.15亿/净利1.08亿/毛利率40.94%极强;⚠️2μm级LDI客户认证时间未查到+LDI市占2027官方测算未查到' },
      { rank:4, name:'东威科技', code:'688700', position:'VCP电镀国内市占>50%·AI订单>5亿 + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述) + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'VCP国内50%+·沪电胜宏东山认证·AI订单5亿+200%·景旺鹏鼎·ABF载板验证', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收3.05亿、归母0.44亿、毛利率37.25%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 204.21倍(3年分位93.15%,asOf:2026-06-21)。AI订单>5亿。三合一电镀设备打破海外垄断',
      ...
      { rank:5, name:'金洲精工', code:'002443', position:'PCB钻针全球第二·全球PCB微钻市占20.8%(C9 v1 豆包核实:中信证券 21% + 中泰证券 20.8% 双 broker 源) ⚠️口径待统一:鼎泰26.8%(2024)/28.9%(2025H1,Frost&Sullivan) + 金洲20.8% 合计47.6%,与原26.5%+20.8%=47.3%略有差异(因鼎泰数据时序更新) ⚠️时序待核:金洲20.8%数据对应年份未独立核实 + Phase 9 PCB 短板补充:🔵broker(Frost & Sullivan 2025) + Phase 9 PCB 短板补充:🔵broker(Frost & Sullivan 2025)', barrier:'中', tier:'primary', valAsOf:'2026-06-22', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'钻针全球第二20.8%·0.02mm沪电·30倍径胜宏景旺·3年长期协议·Q1+76%', logic:'<mark class="updated">2026Q1营收9.36亿、归母0.40亿、毛利率13.03%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 39.44倍(3年分位74.43%,asOf:2026-06-21)。PCB钻针老牌厂商,被鼎泰高科高端化替代·AI纯度低',
        ...
        dims6Note:'🟢 钻针全球第二20.8%(沿用R3-11 broker双源·中信+中泰)+0.02mm超细径沪电认证(2025-Q1 broker双源·兴业+长江)+30倍长径比胜宏市占70-80%(沿用R3-11 broker双源)+50倍长径比验证中(2026-Q1 broker双源);金刚石涂层核心技术+寿命2倍;Q1营收9.36亿/净利0.40亿同比+80%/毛利率13.03%偏低;⚠️全球第二20.8%(broker单源待核)+30倍径"供不应求"(兴业单源)' }
    ]
  },
];
...
(function(){
  ...
  Object.keys(REG).forEach(code => {
    ...
    const segment = orig?.segment || (s.segments && s.segments[0] && s.segments[0].name) || '—';
    ...
    DERIVED.push({
      ...
      logic: manualAnnot?.logic || orig?.logic || `（占位·待补）${s.name} 卡口逻辑 150 字（barrier='极高' 自动筛入·原 chokePoints 列表无注解·待联网核实）`,
  ...
  DERIVED.sort((a, b) => {
    if (a.strengthRank !== b.strengthRank) return b.strengthRank - a.strengthRank;
    if (a.rate !== b.rate) return b.rate - a.rate;
    return String(a.code).localeCompare(String(b.code));
  });

  // ⑤ 重赋 rank
  DERIVED.forEach((c, i) => { c.rank = i + 1; });
  ...
  const chokepointCodes = new Set((CHAINS.pcb.chokePoints || []).map(c => c.code));

  const signalStats = {
    A_total: 0, B_total: 0,
    A_normal: 0, B_normal: 0,
    A_growthAdj: 0, B_growthAdj: 0,
    excluded: { investable: 0, region: 0, loss: 0, extremePe: 0, noBar: 0, noTrend: 0, noVal: 0 },
    asOf: '2026-06-23'
  };

  const deriveSignal = (code, s, v) => {
    // 排除规则
    if (!s.investable) { signalStats.excluded.investable++; return null; }
    if (s.region !== '国内') { signalStats.excluded.region++; return null; }
    if (!v || v.pe_ttm === null) { signalStats.excluded.loss++; return null; }
    if (v.flag && v.flag.indexOf('⚠️PE异常高') >= 0) { signalStats.excluded.extremePe++; return null; }
    if (!['极高', '高'].includes(s.barrier)) { signalStats.excluded.noBar++; return null; }

    const isGrowthAdj = s.growthAdj === true;
    const pctlA = isGrowthAdj ? SIGNAL_THRESHOLDS.PE_PCTL_GROWTH_A : SIGNAL_THRESHOLDS.PE_PCTL_A;
    const pctlB = isGrowthAdj ? SIGNAL_THRESHOLDS.PE_PCTL_GROWTH_B : SIGNAL_THRESHOLDS.PE_PCTL_B;
    ...
    const peAbsMaxOk = !isGrowthAdj || (peAbsMax !== null && v.pe_ttm < peAbsMax);

    // 信号 A
    const signalA = (pePercentile !== null && pePercentile !== undefined)
                  && pePercentile < pctlA
                  && trend === 'up'
                  && peAbsMaxOk;
    // 信号 B
    const signalB = isChokepoint
  ...
  if (CHAINS.pcb.segments) CHAINS.pcb.segments.forEach(seg => injectSignal(seg.stocks));
  ...
  const positionAdvice = (fromHigh, caution) => {
    ...
    if (fromHigh > -0.15) return caution ? '观察（未达-15%）' : '未达仓位阈值';
    if (fromHigh >= -0.20) return caution ? '观察（caution 档未开仓）' : '首仓10%';
    if (fromHigh >= -0.30) return caution ? '首仓10%' : '加仓至20%';
    if (fromHigh >= -0.40) return caution ? '加仓至20%' : '加仓至30%';
    return caution ? '加仓至30%（caution 档上限）' : '⚠️需人工确认（深度回调>40%）';
  };

  const deriveSignalC = (code, s, v) => {
    // 硬性排除
    if (marketRisk === 'extreme') { sigCStats.excluded.marketRisk_extreme++; return null; }
    if (!s.investable) { sigCStats.excluded.investable++; return null; }
    if (s.region !== '国内') { sigCStats.excluded.region++; return null; }
    if (!v || v.pe_ttm === null) { sigCStats.excluded.loss++; return null; }
    if (v.flag && v.flag.indexOf('⚠️PE异常高') >= 0) { sigCStats.excluded.extremePe++; return null; }
    ...
    // trend 排除（条件 A + B 共用）
    if (s.trend === 'down') { sigCStats.excluded.trend_down++; return null; }

    // 缺失字段排除
    if (volRatio5d === null || volRatio5d === undefined) { sigCStats.excluded.volRatio_missing++; return null; }

    const caution = marketRisk === 'caution';
    const pctThresholdA = (pePercentile !== null && pePercentile !== undefined && maxPctl90d !== null && maxPctl90d !== undefined)
      ? (pePercentile - maxPctl90d) : null;
    const pctlB = isGrowthAdj
      ? (caution ? SIGNAL_C.PCTL_GROWTH_B + SIGNAL_C.CAUTION_SHIFT_PCTL : SIGNAL_C.PCTL_GROWTH_B)
      : (caution ? SIGNAL_C.PCTL_NORMAL_B + SIGNAL_C.CAUTION_SHIFT_PCTL : SIGNAL_C.PCTL_NORMAL_B);
    const fromHighA = caution ? SIGNAL_C.FROM_HIGH_A - 0.05 : SIGNAL_C.FROM_HIGH_A;
    const fromHighB = caution ? SIGNAL_C.FROM_HIGH_B - 0.05 : SIGNAL_C.FROM_HIGH_B;
    ...
    let hitA = false;
    if (pctThresholdA !== null && pctThresholdA <= -SIGNAL_C.PCTL_PCTL_RECOVER_A
        && s.barrier === '极高'
        && fromHigh !== null && fromHigh !== undefined && fromHigh <= fromHighA
    ...
    if (pePercentile !== null && pePercentile !== undefined
        && fromHigh !== null && fromHigh !== undefined && fromHigh <= fromHighB
        && volRatio5d <= SIGNAL_C.VOL_RATIO_MAX
        && pePercentile < pctlB
    ...
    // 排除统计（按条件分别记录）
    if (!hitA && pctThresholdA !== null && pctThresholdA > -SIGNAL_C.PCTL_PCTL_RECOVER_A)
      sigCStats.excluded.pctlDrop_insufficient++;
    if (!hitA && !hitB && fromHigh !== null && fromHigh !== undefined && fromHigh > fromHighB)
  ...
  if (CHAINS.pcb.segments) CHAINS.pcb.segments.forEach(seg => injectSignalC(seg.stocks));
  ...
  if (CHAINS.pcb.segments) CHAINS.pcb.segments.forEach(seg => collectSignalC(seg.stocks, seg.name));
  if (CHAINS.pcb.midstream) collectSignalC(CHAINS.pcb.midstream.stocks, '中游制造');
  ...
  CHAINS.pcb.signalCHistory = {
    ...
    runs: [],
    stats: {"totalRuns": 0, "winRate30": null, "winRate60": null, "winRate90": null, "avgReturn30": null, "avgReturn60": null, "avgReturn90": null, "maxWin": null, "maxLoss": null, "triggeredByA": 0, "triggeredByB": 0},
  ...
  const deriveHoldingSignals = (code, s, v) => {
    ...
    if (v.pePercentile !== null && v.pePercentile !== undefined
        && v.pePercentile >= 99
        && v.fromHigh !== null && v.fromHigh !== undefined
        && v.fromHigh > -0.05) {
    ...
    if (v.pePercentile !== null && v.pePercentile !== undefined
        && v.pePercentile >= 95
        && v.volRatio5d !== null && v.volRatio5d !== undefined
        && v.volRatio5d > 2.0) {
      reduceCandidates.push({
  ...
  if (CHAINS.pcb.segments) CHAINS.pcb.segments.forEach(seg => injectHoldingSignals(seg.stocks, seg.name));
  if (CHAINS.pcb.midstream) injectHoldingSignals(CHAINS.pcb.midstream.stocks, '中游制造');

  CHAINS.pcb.holdingMeta = {                                  // 持仓管理信号汇总
    stats: holdingStats,
  ...
  (function injectProsperityValuation() {
    ...
    const asOf = (auto && auto._meta && auto._meta.asOf) ? auto._meta.asOf : '2026-06-24';

    // 读取 3 只核心卡口的实时估值
    const live = CORE_CODES.map(code => {
      const v = valMap[code];
      const stockName = CHAINS.pcb.chokePoints && CHAINS.pcb.chokePoints.find ? (CHAINS.pcb.chokePoints.find(c => c.code === code) || {}).name : code;
      ...
      return {
        ...
        pePercentile: (v && v.pePercentile !== undefined) ? v.pePercentile : null,
    ...
    // 拼接人话摘要（无数据则标 null）
    const fmt = (x, suffix, digits) => (x === null || x === undefined)
      ? '（待补）'
      : digits ? x.toFixed(digits) + suffix : x + suffix;
    const summary = live.map(s => {
      return s.name + '(' + s.code + ') · PE-TTM=' + fmt(s.pe_ttm, 'x', 2)
        + ' · PE历史分位=' + fmt(s.pePercentile, '%', 2)
        + ' · 距前高回落幅度=' + fmt(s.fromHigh, '', 4);
    }).join(' | ');

    // 找到 prosperity.valuation dim 并替换 reason / evidence / src / asOf
    const dimVal = (CHAINS.pcb.prosperity && CHAINS.pcb.prosperity.dims)
      ? CHAINS.pcb.prosperity.dims.find(d => d.key === 'valuation') : null;
    if (dimVal) {
      dimVal.reason = '⚠️本轮最大扣分项：3 只核心卡口估值口径须**分别看待**——' + summary + '。综合 1 分=门控触发，挡掉"业绩爆表+泡沫"陷阱。下钻见各卡口 valuation 与 holdingMeta。';
      dimVal.evidence = 'roll-up 自 auto.valuations（3 只 code）/ ' + asOf;
      dimVal.src = '★ commit 4.21：动态读取 PCB_AUTO.valuations[code].pe_ttm + pePercentile + fromHigh·asOf=' + asOf + '·不再写死旧值';
      dimVal.asOf = asOf;
  ...
  // ============================================================
  CHAINS.pcb.demandChainMeta = {                              // 下游需求传导信号汇总
    config: {
      asOf: '2026-06-24',
      period: '2025-2028',
    ...
    segments: [
      // 1) AI 服务器
      {
        key: 'aiServer', name: 'AI 服务器', sharePct: 40,
        cagr: 32, cagrRange: '30%-35%', cagrTier: 'broker',
        cagrSrc: [
          { tier: 'broker', name: '招商证券《PCB 行业 2026 年投资策略》', date: '2025-12-25',
            quote: 'AI 算力革命驱动 PCB 需求结构性增长，AI PCB CAGR 稳定 25%-30%，是未来 5 年行业增长的核心增量' },
          { tier: 'broker', name: '摩根士丹利《AI 光模块 PCB 行业深度报告》', date: '2026-06-16',
            quote: 'AI 服务器 PCB 整体 2025-2028 年 CAGR 达 32.7%' },
          { tier: 'media',  name: '电子工程专辑《PCB 与封装基板产业格局正在重塑》', date: '2026-04-14',
            quote: '服务器/数据存储板块以 42% 的同比增速远超其他领域，2026 年预计增长 32%，核心驱动力正是 AI 数据中心资本开支的爆发式扩张' }
        ],
        valueMult: 10, valueMultRange: '8-12 倍', valueMultNote: '价值量倍数（用量约 3-5 倍）',
        valueMultSrc: [
          { tier: 'broker', name: '高盛《AI 服务器硬件拆解报告》', date: '2026-04-27',
            quote: '传统服务器 PCB：500-800 美元/台（8-12 层）；AI 服务器 PCB：8000-10000 美元/台（20-40 层，M8/M9 高速材料）；高端 GB300 机型：70 层以上，单台 PCB 价值提升至 8000-15000 美元，价值量提升 8 至 12 倍' },
          { tier: 'broker', name: '国金证券《AI 服务器中到底需要多少 PCB?》', date: '2024-12-16',
            quote: 'AI 服务器所用 PCB 单机价值量相对普通服务器提升 532%（约 5.3 倍）' },
          { tier: 'broker', name: 'Prismark《2026 年 Q1 PCB 和基板市场概述》', date: '2026-03-29',
            quote: 'AI 服务器配套高多层、高频高速 PCB 单机高端 PCB 价值量是传统服务器的 5-8 倍' }
        ],
        note: '高盛/国金/Prismark 三源价值量倍数 5-12 倍区间·按 broker 共识取 8-12 倍（含 GB300 高端机型）'
      },
      // 2) 汽车电子
      {
        key: 'auto', name: '汽车电子', sharePct: 25,
        cagr: 4.2, cagrRange: '3.5%-5.1%', cagrTier: 'broker',
        cagrSrc: [
          { tier: 'broker', name: 'Prismark《2026 年 3 月全球 PCB 市场报告》', date: '2026-03-01',
            quote: '2025 年汽车相关 PCB 市场为 97 亿美元，较 2024 年增长 5.7%，2026 至 2030 年复合增长率为 3.5%' },
          { tier: 'broker', name: 'Prismark《2025 年全球 PCB 市场展望》', date: '2025-10-22',
            quote: '2024 年至 2028 年全球汽车电子 PCB 复合年均增长率为 5.1%' },
          { tier: 'broker', name: '生益电子(688183) 经营分析', date: '2026-04-24',
            quote: '根据 Prismark 数据，2025 年汽车 PCB 市场增长 5.3%，2024-2029F 年平均复合增长率为 4.2%' }
        ],
        note: 'Prismark 两份报告 + 生益电子转引·三源 CAGR 区间 3.5%-5.1%·中位 4.2%'
      },
      // 3) 通信/5G
      {
        key: 'comm', name: '通信/5G', sharePct: 20,
        cagr: 5.4, cagrRange: '5.4%-8%', cagrTier: 'broker',
        cagrSrc: [
          { tier: 'broker', name: 'Prismark《2025 年全球 PCB 市场展望》', date: '2025-10-22',
            quote: '2024 年至 2028 年全球通讯 PCB 复合年均增长率为 5.4%' },
          { tier: 'media',  name: '电子工程专辑《PCB 与基板市场概览与展望》', date: '2026-04-23',
            quote: '5G 基站、1.6T 交换机、光模块带动高频高速 PCB 需求，2026 年增速维持 10% 左右' },
          { tier: 'primary', name: '鹏鼎控股(002938) 经营总结', date: '2026-04-03',
            quote: '2025 年通讯用板业务实现营业收入 254.37 亿元，同比增长 4.95%' }
        ],
        note: 'Prismark 通讯 CAGR 5.4% + 鹏鼎 2025 通讯板 +4.95% 印证·电子工程专辑提及 2026 维持 10% 增速'
      },
      // 4) 消费电子
      {
        key: 'consumer', name: '消费电子', sharePct: 15,
        cagr: 2.8, cagrRange: '2.6%-3.0%', cagrTier: 'broker',
        cagrSrc: [
          { tier: 'broker', name: 'Prismark《2026 年 3 月全球 PCB 市场报告》', date: '2026-03-01',
            quote: '2025 年消费电子相关 PCB 产值 94 亿美元，较 2024 年增长 5.6%，2026 至 2030 年复合增长率为 2.6%' },
          { tier: 'media',  name: '电子工程专辑《PCB 与封装基板产业格局正在重塑》', date: '2026-04-14',
            quote: '消费电子板块 2025 年同比增长 3.2%，2026 年预计增长 2.8%，增速相对平稳' }
        ],
        note: 'Prismark CAGR 2.6% + 电子工程专辑 2026 预计 2.8%·区间 2.6%-3.0%·消费电子增速最弱'
      }
    ],
    conductionTBD: true,                                     // 传导系数·待补充
    conductionNote: '传导系数（elasticCoefficient·下游 X% → 上游 PCB 需求 Y%）待补充·需券商研报 / 行业历史数据进一步核实',
