...
CHAINS.pcb.segments = [
  ...
  },
  {
    ...
    stocks: [
      { rank:1, name:'东材科技', code:'601208', position:'全球唯二M9碳氢树脂认证·国内唯一 + Phase 9 PCB 短板补充:🔵broker(M9 认证公告 + CPCA 2026) + Phase 9 PCB 短板补充:🔵broker(M9 认证公告 + CPCA 2026)', barrier:'极高', tier:'primary', valAsOf:'2026-04-23', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'Q1+103%·台光排他', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收14.44亿、归母净利1.87亿+103%、毛利率17.13%</mark>(2026-04-23季报,tier:primary,src:akshare/新浪财经(基于公司季报));高速电子树脂营收2.58亿+131%;PE-TTM 198.72倍(3年分位63.47%,asOf:2026-06-21)。台光独供2-3年排他协议。眉山3500吨<mark class="updated">2026年6月30日投料试产(提前至Q2末)</mark>。高速电子级碳氢树脂供应商·价格/毛利率数据待2025年报树脂业务分项披露后核实 ⚠️口径待统一:价格80-120万元/吨+毛利50%+,协会极少披露价格区间 ⚠️单源待核:价格80-120万元/吨+毛利50%+(协会极少披露) ⚠️asOf待核:眉山3500吨 2026/6/30 投料试产 应标具体披露日(迫近 2026-06-16)',
      ...
      { rank:3, name:'世名科技', code:'300522', position:'盘锦500吨已投产·M9方案已认证 ⚠️单源待核:盘锦500吨已投产 vs logic规划2500吨混淆 ⚠️待核:具体产能数字(500吨/2500吨)未找到协会/公告≥2源核实 + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述) + Phase 9 PCB 短板补充:⚪media(公司公告 + 行业转述)', barrier:'高', tier:'primary', valAsOf:'2026-04-15', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'M9方案已认证·扩产·Q1净利0.02亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收1.52亿、归母0.02亿、毛利率25.26%</mark>(2026-04-15季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 362.12倍(3年分位27.31%,asOf:2026-06-21)</mark>。已通过台光/生益/联茂M9方案认证,规划总产能2500吨·H2放量 ⚠️口径待统一:盘锦500吨已投产 vs position 2500吨,当前 vs 规划混淆',
      ...
      { rank:4, name:'宏昌电子', code:'603002', position:'环氧树脂龙头·GBF增层膜送样 + Phase 9 PCB 短板补充:🔵broker(中国电子材料协会 2026 + 公司公告) + Phase 9 PCB 短板补充:🔵broker(中国电子材料协会 2026 + 公司公告)', barrier:'中', tier:'primary', valAsOf:'2026-04-29', src:'akshare/新浪财经(基于公司季报)', trend:'flat', trendNote:'环氧树脂壁垒低·Q1净利0.005亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收9.89亿、归母0.005亿、毛利率4.87%</mark>(2026-04-29季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 910.07倍(3年分位58.20%,asOf:2026-06-21)</mark>。GBF增层膜送样台积电/长电,但环氧树脂壁垒低→非卡口;Q1毛利率仅4.87%,业绩弹性极弱',
  ...
  },
  {
    ...
    stocks: [
      ...
      { rank:3, name:'中材科技', code:'002080', position:'国内Low Dk市占35%·石英布独供胜宏GB300 + Phase 9 PCB 短板补充:🟢primary(中材科技 2025 年报) + Phase 9 PCB 短板补充:🟢primary(中材科技 2025 年报)', barrier:'中', tier:'primary', valAsOf:'2026-04-25', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'石英布独供GB300·送样Rubin·Q1净利5.07亿', hits:null, strength:null, logic:'<mark class="updated">2026Q1营收68.54亿、归母5.07亿、毛利率20.94%</mark>(2026-04-25季报,tier:primary,src:akshare/新浪财经(基于公司季报));PE-TTM 68.86倍(3年分位72.25%,asOf:2026-06-21)。Q布占特种纤维布约20-30%,特种纤维布占公司总营收2.08%(C8 v1 豆包核实:primary 中材公告 + 华泰证券 双源);非前三寡头·主业玻纤稳',
  ...
  },
  {
    ...
    globalLandscape: [
      ...
      { lbl: '铜冠铜箔（中）', val: '国内唯一HVLP1-4全系列量产', note: '2026年底HVLP产能目标300吨/月(公司披露+券商确认)' },
      { lbl: '德福科技（中）', val: 'HVLP3量产，HVLP4验证中', note: '进入英伟达供应链' }
    ],
    stocks: [
      { rank:1, name:'铜冠铜箔', code:'301217', position:'国内唯一HVLP1-4全系列量产·2027市占预期42% ⚠️待核≥2源:日韩四强垄断85%+(Prismark) + Phase 9 PCB 短板补充:🟢primary(铜冠铜箔 2025 年报 + Prismark) + Phase 9 PCB 短板补充:🟢primary(铜冠铜箔 2025 年报 + Prismark)', barrier:'极高', tier:'primary', valAsOf:'2026-04-28', src:'akshare/新浪财经(基于公司季报)', trend:'up', trendNote:'设备锁定70%·2027市占42%·Q1净利1.06亿', hits:4, strength:'★★★', logic:'<mark class="updated">2026Q1营收18.42亿、归母1.06亿、毛利率8.79%</mark>(2026-04-28季报,tier:primary,src:akshare/新浪财经(基于公司季报));<mark class="updated">PE-TTM 1009.48倍(3年分位92.08%,asOf:2026-06-21)</mark>。<mark class="updated">锁定10台三船MSP-8000表面处理机(全球70%),产能确定性最强(C1 v1 豆包核实:primary 投资者关系活动 + 中信证券 + 中泰证券 三源)</mark>。2026目标500吨/月。日韩四强垄断85%+。设备交期18-24月(C4 v1 豆包核实:primary 投资者关系活动 + 海通证券 双源)。2027年HVLP铜箔市占率目标40%(券商测算)。已实现HVLP4规模化量产 ⚠️口径待统一:2027中国1厂42% vs 日韩合计85%+,两口径统计基础不同 ⚠️单源待核:锁定10台三船MSP-8000(全球70%)+2026目标500吨/月+2027市占42%+设备交期18-24月 四数据全单源',
