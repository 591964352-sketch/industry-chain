...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '601208': { code:'601208', name:'东材科技', rank:1, barrier:'极高', tier:'primary',
      ...
      dims6:[{key:'durability',score:3,trend:'down',tier:'L4'},{key:'visibility',score:2,trend:'down',tier:'L4'},{key:'policy',score:4,trend:'flat',tier:'L2'},{key:'supply',score:3,trend:'down',tier:'L3',reason:'圣泉Q4新增1500吨碳氢+眉山项目2026-06-30投料试生产;行业供给端已增加,综合 3'},{key:'valuation',score:2,trend:'down',tier:'L4',reason:'PE-TTM 34.72 倍/5 年分位 76.4%(asOf 2026-06-22),落入 70-85% 区间,严格匹配 §10 估值 2 分档位;海外 CCL 同业中位数 24.49(联茂 22.15/台光 26.83/南亚电路板 18.92/村田 31.47),估值溢价偏大,性价比偏弱;华泰/东吴/东北证券 L4 三源确认 → 2'},{key:'barrier',score:3,trend:'down',tier:'L3',reason:'圣泉已M9批量+Q4新增1500吨,加工端≥2家量产,卡口转移到上游碳氢单体'}],
