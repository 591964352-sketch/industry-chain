...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '605006': { code:'605006', name:'山东玻纤', rank:5, barrier:'中', tier:'primary',
      ...
      dims6:[{key:'durability',score:3,trend:'up',tier:'L1',reason:'AI 服务器对 Low-Dk 玻纤布需求结构性增长 + 5G/汽车 PCB 玻纤布稳定 + 2024-2025 营收 V 型反转(2024 19.87 亿 → 2025 24.85 亿,+25.06%);经 baostock 2023-2025 真实营收数据反算 CAGR 6.86%(2 年),与豆包原始查询 7.2% 偏差 5%,方向一致,已核实 → 3'},{key:'visibility',score:3,trend:'up',tier:'L1',reason:'营收同比 +25.06%(2024 → 2025)/ 归母净利亏损同比收窄 86.4%(从 -0.9893 亿到 -0.1343 亿)/ 2026Q1 短暂盈利(baostock 显示 2026-03-31 PE +458.42 倍)/ 2025 年报披露电子布+玻纤纱主营占比 83.88%(L1 akshare);业绩可见度改善但尚未确立稳定拐点 → 3'},{key:'policy',score:3,trend:'flat',tier:'estimate',reason:'电子级玻纤布纳入国产替代目录+玻纤行业窑炉能耗政策(GB/T 标准趋严)中长期偏顺风;短期无直接利好催化,政策中性 → 3 ｜605006 本轮查询中 valuation 维度被证实完全编造(虚构 PE 分位)、visibility 维度被证实方向性错误(净利同比与实际亏损收窄趋势相反),本维度未做独立交叉验证,存在同批次污染风险,待后续复核'},{key:'supply',score:2,trend:'flat',tier:'L3+L4',reason:'全球电子级玻纤布供给格局集中度较高,头部 4 家市占率合计约 62%(Prismark 2026 全球玻纤榜单)/ 行业供需缺口不足 10%,整体供给略过剩;山东玻纤作为国内 ECR 玻纤纱中端供应商,行业地位中等 → 2;公司未披露细分产能数据,产能/利用率相关判断均基于行业供给格局推断,非公司自身产能数据 ｜来源:L3 Prismark《2026 全球玻纤产业报告》+ L3 CPCA 行业数据 + L4 国金证券玻纤行业深度'},{key:'valuation',score:2,trend:'flat',tier:'L1+L4',reason:'PB(MRQ) 5.062(2026-07-02 baostock L1 实证,从 2024-01 的 1.586 涨 2 年 3.2 倍)/ PS ~4.0(总市值约 100 亿/2025 营收 24.85 亿)/ 亏损收窄但未形成稳定拐点(2026Q1 短暂盈利后 Q2 又回亏 PE -720 倍)/ 同段位对标菲利华/宏和/中国巨石/中材科技 PB 中位数约 3-5,处于偏高位 → 2 ｜亏损企业 estimate 规则:PE-TTM 不适用,采用 PB/PS 替代 ｜来源:L1 baostock PB/PS 实证 + L4 东吴/国金证券玻纤行业研报'},{key:'barrier',score:3,trend:'flat',tier:'estimate',reason:'ECR 玻纤纱认证壁垒约 18+ 月 / 全球可量产厂家 5-8 家(日本日东纺/Nittobo、美国 AGY、中国巨石/泰山玻纤/重庆国际等)/ 玻纤池窑建设周期 18-24 月构成设备瓶颈 / 公司在中端 ECR 电子级玻纤纱有产品壁垒但非独家 → 3 ｜605006 本轮查询中 valuation 维度被证实完全编造(虚构 PE 分位)、visibility 维度被证实方向性错误(净利同比与实际亏损收窄趋势相反),本维度未做独立交叉验证,存在同批次污染风险,待后续复核'}],
