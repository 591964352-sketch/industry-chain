...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '300395': { code:'300395', name:'菲利华', rank:1, barrier:'极高', tier:'primary',
      ...
      dims6:[{key:'durability',score:5,trend:'up',tier:'estimate'},{key:'visibility',score:5,trend:'up',tier:'estimate'},{key:'policy',score:3,trend:'flat',tier:'estimate'},{key:'supply',score:5,trend:'up',tier:'estimate'},{key:'valuation',score:1,trend:'down',tier:'estimate'},{key:'barrier',score:4,trend:'flat',tier:'L3',reason:'Q布认证阶段(2025收入9837.37万/占比4.88%),认证壁垒6-18月区间;石英砂非独家,卡口转移到上游高纯石英砂原料'}],
