...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '002636': { code:'002636', name:'金安国纪', rank:4, barrier:'中', tier:'primary',
      ...
      investableReason:'所有核心事实来自 L1 公司公告（2026 一季报+2026 定增预案+2026-06-15 定增问询函回复）+ L4 头部券商(行业竞争格局定性,具体券商名称待后续人工补充核实)研报。2026Q1 归母 2.02 亿（+763.91%），扣非 2.15 亿（+698.7%），无重大一次性损益（L1）。主营拆分：CCL 11.34 亿（90%·毛利率 28.3%）+ PCB 0.98 亿（7.8%）+ 贸易 0.28 亿（2.2%）（L1）。业绩归因：覆铜板量价齐升（均价 +30%+）+ 基数低（2025Q1 净利 0.23 亿）+ 无一次性损益（L1）。现有产能 6000 万张/年，产能利用率 95%+，产销率 100%（L1）。宁国高端覆铜板技改项目 1600 万张/年高频高速 CCL，预计 2026 年 7 月投产（L1）。2026 定增 13 亿扩产 4000 万㎡高等级 CCL，投产后高端年产能 3600 万张（+80%）（L1）。M7 高速 CCL 已量产 · M8 样品认证（L4）。车规级 CCL 2026Q1 0.87 亿（+123.6%）（L1）。trend 判定 up｜口径:M9等级细分品类口径',
      investableReason:'所有核心事实来自 L1 公司公告（2026 一季报+2026 定增预案+2026-06-15 定增问询函回复）+ L4 头部券商(行业竞争格局定性,具体券商名称待后续人工补充核实)研报。2026Q1 归母 2.02 亿（+763.91%），扣非 2.15 亿（+698.7%），无重大一次性损益（L1）。主营拆分：CCL 11.34 亿（90%·毛利率 28.3%）+ PCB 0.98 亿（7.8%）+ 贸易 0.28 亿（2.2%）（L1）。业绩归因：覆铜板量价齐升（均价 +30%+）+ 基数低（2025Q1 净利 0.23 亿）+ 无一次性损益（L1）。现有产能 6000 万张/年，产能利用率 95%+，产销率 100%（L1）。宁国高端覆铜板技改项目 1600 万张/年高频高速 CCL，预计 2026 年 7 月投产（L1）。2026 定增 13 亿扩产 4000 万㎡高等级 CCL，投产后高端年产能 3600 万张（+80%）（L1）。M7 高速 CCL 已量产 · M8 样品认证（L4）。车规级 CCL 2026Q1 0.87 亿（+123.6%）（L1）。trend 判定 up',
