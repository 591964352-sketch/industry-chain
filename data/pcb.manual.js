...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '002916': { code:'002916', name:'深南电路', rank:1, barrier:'极高', tier:'primary',
      ...
      dims6:[{key:'durability',score:4,trend:'up',tier:'estimate'},{key:'visibility',score:4,trend:'up',tier:'estimate'},{key:'policy',score:4,trend:'up',tier:'estimate'},{key:'supply',score:3,trend:'flat',tier:'L3+estimate',reason:'全球ABF加工端2026-27年日台韩头部同步扩产,行业整体供给略过剩(SEMI《2025 全球 IC 封装基板产业年度报告》+Prismark《2026 全球 IC 载板供需预测白皮书》L3 双源确认)/但公司作为大陆唯一ABF批量交付企业,享受稀缺性溢价定价权(华为昇腾一供>60%);行业层面略过剩+企业层面稀缺性并存,综合 score=3'},{key:'valuation',score:2,trend:'down',tier:'estimate',reason:'PE-TTM 75.69 倍/3 年分位 99.60%(asOf 2026-06-16),估值已透支,趋势向下(性价比恶化);卡口逻辑已充分定价 → 2'},{key:'barrier',score:5,trend:'flat',tier:'estimate'}],
