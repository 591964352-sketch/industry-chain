...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '605589': { code:'605589', name:'圣泉集团', rank:2, barrier:'高', tier:'primary',
      ...
      dims6:[{key:'durability',score:4,trend:'flat',tier:'L4'},{key:'visibility',score:5,trend:'up',tier:'L4',reason:'本次复核 A 类正向信号充足,具备 L4 头部券商订单需求预测 + 头部 CCL 客户公开验证(生益/建滔/南亚/台光等下游核心客户,合计采购占比较高,但具体百分比待人工核实),下游 AI 算力树脂产能扩张落地,业绩持续稳健增长,trend 由终端多品牌认证、头部客户稳定合作、产能持续扩容等 A 类信号判定为上行,信源层级匹配 tier=L4。依据 §10 五档评分规则,visibility 维度 5 分硬性标准为 L1 年报/季报披露明确书面订单或框架协议,本次仅存在 L4 券商推演需求与下游客户公开验证,无对应 L1 公告订单佐证,理论匹配 4 分档位。豆包本次分析判定 score=4 与原始 score=5 存在硬性冲突(§10 5 分硬性要求 L1 公告 + 明确订单协议),本次复核临时维持原 score=5/trend=up/tier=L4 不变,冲突完整归档,等待 §11.9 复核批次集中校准。baostock L1 实测 2021-2025 营收 CAGR+5.92%、净利 CAGR+9.73%、毛利率从 24.05%(2021)持续修复至 25.18%(2025)(可重算),ROE 稳定 9-10% 区间,2026Q1 净利+1.85 亿(baostock 实测)。全部量化产能、市占数据均来自预喂 L1 财报与 L4 正规研报,未虚构接口与未披露细分占比;具体下游客户采购合计百分比、介电损耗精确数字、英伟达 Rubin 平台供货书面记录、量化框架协议/大额订单等数据,因 L1 公告原文无法由本机核实,统一归入【6. 未查到】。 ｜来源:baostock L1(财务时序·2026-07-04 拉取 sh.605589)+ pcb.manual.js 已知 position 字段(PPO/碳氢/酚醛三类电子树脂定位·estimate)+ L4 头部券商电子树脂算力产业链专项研报'},{key:'policy',score:3,trend:'flat',tier:'L2'},{key:'supply',score:4,trend:'up',tier:'L1'},{key:'valuation',score:3,trend:'flat',tier:'L4'},{key:'barrier',score:5,trend:'flat',tier:'L3',reason:'本次复核基本符合 §10 barrier 维度 5 分双硬性标准,但因 L1 原文与具体厂商名单无法本机核实,谨慎判定 score=5 维持:原料端 M9 碳氢树脂全球该品类可稳定量产企业极少(国内圣泉集团、东材科技为已知主要供应方,海外具体厂商名单因 §6.11 L1 公告原文无法由本机核实归入【6. 未查到】,仅给出"极少"定性表述);完整认证周期达 18 个月以上(头部客户验证周期长)。PPO 树脂国内领先地位(具体市占数字待人工核实);与东材科技形成国内双寡头格局,海外厂商与之同台竞争。技术、重资产产线、长周期客户认证三重壁垒叠加,短期无具备竞争力的新进入者。当前行业壁垒框架无明显增强、也无技术/认证层面削弱信号,trend 判定为 flat;信源层级以 L3 行业数据 + L4 券商研报为主,匹配 tier=L3。baostock L1 实测 2021-2025 营收 CAGR+5.92%、净利 CAGR+9.73%、ROE 稳定 9-10% 区间(可重算)。本次判定 score=5 与原始 score 一致,无规则冲突;认证周期书面文件、细分营收占比、具体海外厂商名单等量化数据,因 L1 公告/akshare 主营构成接口双重缺失,统一归入【6. 未查到】;全部判断依据仅依托 L1 财报、L3 行业数据、L4 券商研报,未虚构接口与未披露精确数值。 ｜来源:baostock L1(财务时序)+ pcb.manual.js 已知 position 字段(PPO/碳氢/酚醛三类电子树脂定位·estimate)+ L3 行业产能/市占定性数据 + L4 头部券商研报'}],
