...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '603228': { code:'603228', name:'景旺电子', rank:4, barrier:'中', tier:'primary',
      ...
      dims6:[{key:'durability',score:4,trend:'up',reason:'2024 年首次成为全球第一大汽车 PCB 供应商(2023 已进全球前三);英伟达 H100/GB300 交换机托盘核心供应商之一;汽车+消费双轮+AI 高阶 HDI 转型,延续性高 → 4',verifiedAt:'2026-06-23'},{key:'visibility',score:4,trend:'up',reason:'60 层 AI 服务器板（AMD MI300）已量产良率 99.2%；mSAP 光模块 PCB 已量产毛利率 40%；吉安 70 万平 Q3 满产·泰国 H2 投产 → 4',verifiedAt:'2026-06-30'},{key:'policy',score:3,trend:'flat',reason:'汽车 PCB+AI 高阶 HDI 政策中性,趋势走平 → 3',verifiedAt:'2026-06-23'},{key:'supply',score:4,trend:'up',reason:'吉安 70 万平 6 月试产 Q3 满产 · 泰国 16 层 HDI 基地 2026H2 投产 → 4',verifiedAt:'2026-06-30'},{key:'valuation',score:3,trend:'flat',reason:'PE-TTM 67.58 倍/3 年分位 99.42%(asOf 2026-06-16),估值高位但业绩反转预期强 → 3',verifiedAt:'2026-06-30'},{key:'barrier',score:4,trend:'up',reason:'60 层 AI 服务器板良率 99.2%(良率口径·行业第一梯队) / mSAP 工艺光模块 PCB 毛利率 40%(毛利率口径) / 高端客户占比 71%(客户结构占比口径) → 4',verifiedAt:'2026-07-03'}],
