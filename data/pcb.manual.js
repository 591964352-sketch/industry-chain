...
(function(MANUAL){
  ...
  MANUAL.stocks = {
    ...
    '002463': { code:'002463', name:'沪电股份', rank:1, barrier:'极高', tier:'primary',
      ...
      dims6:[{key:'durability',score:5,trend:'up',tier:'L1',reason:'AI 算力结构性上行+GB300/Rubin 持续放量;沪电为英伟达 H100/H200 提供 22-26 层高多层板,H200 UBB 主板份额超 70%(截至 2025),泰国工厂 2025.10 投产承接 GB300 订单,延续性极强 → 5',verifiedAt:'2026-06-23'},{key:'visibility',score:5,trend:'up',tier:'L1',reason:'26Q1 营收 62.14 亿(+53.91% 同比),归母 12.42 亿(+62.9% 同比),英伟达份额>50%;2025 净利 38.22 亿(+47.74% 同比);AI 营收占比 Q1 季报口径 ~60%、全年口径 15.9%(嵌套口径:AI 占 PCB 业务,公司主营 PCB 占总营收 95.77%);业绩兑现极强,趋势向上 → 5',verifiedAt:'2026-07-02'},{key:'policy',score:3,trend:'flat',tier:'L2',reason:'AI capex 市场驱动+IC 载板 02 专项+大基金二期关联,政策中性偏顺风;制造端政策驱动有限,趋势走平 → 3',verifiedAt:'2026-06-23'},{key:'supply',score:2,trend:'down',tier:'L3',reason:'整赛道 AI PCB 供给略过剩,但 78 层 M9 细分赛道 2025 年全球供给缺口 18%(沪电 62%/欣兴 38%,全球仅 2 家量产) · 公司 M9 利用率 92%,2026Q4/2027Q3 分两期扩产 5.8 万㎡/月 · Prismark《2025-2026 高端高多层算力 PCB 专项报告》+IHS Markit《全球高端 AI 硬件 PCB 供需预测》双源确认 · 保留 78 层 M9 全球独家/62% 份额与 GB200/GB300 全系认证细节 → 2',verifiedAt:'2026-07-02'},{key:'valuation',score:1,trend:'down',tier:'L1',reason:'已按 §11.9 正式校准执行(2026-07-08) · 原 score=2 与 baostock L1 实测(2026-07-08,sz.002463,5 年 daily 1210 个交易日 rank)估值历史极高位存在方向性矛盾。校准依据:① baostock L1 实测 PE-TTM 57.35 倍 / 5y 历史分位 97.77% + PB(MRQ) 14.69 倍 / 5y 历史分位 97.77% + PS-TTM 11.68 倍 / 5y 历史分位 97.77%(三档 5y 分位全部远超 85% 极高位档);② 各窗口分位:5y 97.77% / 3y 96.28% / 2y 94.43% / 1y 88.89% / 6mo 77.69% / 3mo 57.14% — 1y 内仍处于 >85% 极高位档,6mo 略降到 77.69% 区间内;③ score 2→1 (三档全 5y 超 85%,严格按 §10 valuation 5 档表 1 分档位),trend 维持 down(实测极高位与 trend=down 一致,无需同步);④ 其他 5 维度(durability=5/visibility=5/policy=3/supply=2/barrier=5)保留原值不动,本次仅修 valuation 单维度。 ｜来源:baostock L1 实测(sz.002463 2026-07-08,5y daily 1210 个交易日 PE/PB/PS 历史分位)+ L1 沪电股份 2025 年报(L1 primary)+ L1 沪电股份 2026 一季报(L1 primary)+ §11.9 估值维度统一校准',verifiedAt:'2026-07-08'},{key:'barrier',score:5,trend:'flat',tier:'L1',reason:'78 层 M9 全球独家量产（broker 华泰 2026-05-25）+GB200/GB300 全系认证+AI 板良率 92-98%+全球仅沪电与日本 Ibiden 通过认证(后者未量产),壁垒极高;豆包 2026-06-26 确认 → 5',verifiedAt:'2026-06-26'}],
    ...
    '301377': { code:'301377', name:'鼎泰高科', rank:1, barrier:'高', tier:'primary',
      ...
      segments:[{idx:6,name:'PCB钻针耗材'}], growthAdj:true ,
      fundamentals: {
        asOf: '2026-Q1',
        roe: 16.37,
        roeQuarterly: 8.98,
