...
CHAINS["semicon-equip"] = {
  ...
  "plainIntro": {
    ...
    "fullGuide": {
      "opening": "如果把芯片制造比作在米粒上雕花，半导体设备就是那套「全世界最精密的雕刻工具」。一颗芯片从沙子变成能跑AI大模型的处理器，需要经过几百道工序——光刻、刻蚀、薄膜沉积、抛光、清洗——每一道工序都需要一台专门的设备。这些设备的精度要求堪比「从北京扔一颗乒乓球到纽约、偏差不能超过1厘米」——稍有偏差，整颗价值数万美元的芯片就废了。<br><br>这就是半导体设备行业的本质：它不是制造业，是「精密工艺的物理极限竞赛」。全球能做出这种精度设备的公司，一只手数得过来——而中国，正在从零开始追赶。大基金三期的天量投资、国家02专项的持续攻关、美国出口管制倒逼的国产替代需求——这三股力量正在同时推动中国半导体设备行业经历一场前所未有的系统性建设。",
      "storyLine": [
        {
          "title": "⚙️ 零部件篇：「设备的设备」——精密零件的隐形冠军",
          "content": "半导体设备本身也需要零件——高纯度的石英件、精密的陶瓷件、超高真空的密封件。如果把半导体设备比作精密机床，这些零部件就是机床里的轴承、齿轮和导轨——没有它们，再精密的机床也转不起来。<br><br>这个环节的中国代表是<strong>富创精密</strong>和<strong>京仪装备</strong>。富创精密是国内半导体设备精密零部件的平台型供应商，产品覆盖刻蚀、薄膜沉积、清洗等几乎所有前道设备的零部件需求。京仪装备则聚焦温控系统和废气处理设备——这两样是晶圆厂维持洁净室环境的必需配套。<br><br>两家公司的共同特点是：它们做的事情单个来看都不算「全球寡头」（barrier=4·高·非5），但它们在国产设备供应链中扮演了「基础设施」的角色——就像城市里的自来水管和电线，平时不被注意到，但一旦断了，整个城市的运转就会瘫痪。这个环节在半导体设备产业链中是最不性感、最不被资本市场关注的——但对于正在从零建设整套芯片设备工业体系的中国来说，零部件自主配套的重要性也许被低估了。富创精密营收+37%但ROE仅-0.19%（仍在投入期），京仪装备营收+16%但PE极度高估（timing=20）——「好方向、贵标的、还在烧钱」，是这个环节的共同标签。"
        },
        {
          "title": "🔪 刻蚀+薄膜篇：纳米雕刻刀与原子贴膜机",
          "content": "芯片制造里最核心的两道工序是刻蚀和薄膜沉积。刻蚀就像在晶圆表面「雕刻」出纳米级的电路图案——用等离子体把不需要的材料「挖掉」。薄膜沉积则相反——在晶圆表面「镀」上一层原子级厚度的薄膜，用于绝缘或者导电。一个做减法、一个做加法。<br><br><strong>中微公司</strong>的CCP刻蚀设备已经做到了全球前三——仅次于美国应用材料（AMAT）和泛林半导体（Lam Research），并且打入了全球最先进的台积电5nm产线。这是中国半导体设备产业最引以为傲的成就之一。但中微的故事有一个「另一面」：它的成功集中在CCP刻蚀（刻介质材料），在ICP刻蚀（刻硅和金属）领域它仍然落后于Lam Research。而且2025年净利掉了64.6%——不是因为设备卖不动了（营收还增长了37%），而是因为研发投入和扩产资本开支太猛了。就像一家餐厅明明客流在增长，但老板把钱全投在了装修新店上——眼下不赚钱，赌的是将来。<strong>拿到入场券不等于成了主角</strong>，中微离Lam Research的ICP水平还有路要追。<br><br><strong>北方华创</strong>是另一个级别的选手——它是国内半导体设备的「全能王」：刻蚀、薄膜、PVD、CVD、炉管几乎全做。营收接近400亿，体量是中微的4倍。但北方华创也有自己的烦恼：2025年净利同比下降约2%，增收不增利。就像一家庞大的建筑集团——什么工程都能接，但利润率被庞大的体量和分散的业务线摊薄了。<br><br><strong>拓荆科技</strong>是国内PECVD/ALD薄膜沉积设备的龙头，方向正确——营收+59%（相当快），但有一个「甜蜜的烦恼」：它在快速追赶期，研发烧钱太猛，净利的增长远跟不上营收的增速。拓荆的visibility评分只有2分（低）——不是因为它不透明（L1年报数据都公开可查），而是因为「订单能否转化为利润」这条传导链条还太脆弱。就像一个在读博士研究生——课题方向选对了、实验数据在积累、论文也在发，但离毕业拿工资还有不少路要走。"
        },
        {
          "title": "🪥 CMP+去胶篇：表面处理的隐形冠军",
          "content": "CMP（化学机械抛光）和去胶（光刻胶剥离）在工艺上没有先后关系——但它们有一个共同的身份：芯片制造流程里的「表面处理工种」。一个负责把晶圆表面抛平到原子级别（CMP），一个负责把刻蚀后残留的光刻胶清除干净（去胶）。不是最核心的图案创造工序，但没有它们，前面的精密加工全白费。<br><br><strong>华海清科</strong>的CMP设备是全球仅三家可量产的公司之一——另外两家是美国应用材料（AMAT）和日本荏原（EBARA）。就像全球只有三家公司能造芯片工厂专用的「超级抛光机」——华海清科是其中唯一的中国面孔。它的barrier=5（极高，全球≤3家），是正式物理卡口★★★。但有一个「好赛道贵标的」的反差：valuation=2（估值偏高）、timing=40——方向确定不容置疑，但PE分位不便宜。而且CMP设备不是卖一台就完事的——它需要耗材配套（抛光液、抛光垫），而这些耗材被美国Dow和Cabot两家主导。华海清科卖的是「咖啡机」——可以卖进星巴克，但咖啡豆还得找别人买。<br><br><strong>屹唐股份</strong>是一个更不为人知的故事：全球去胶设备市场是一个双寡头格局——韩国PSK（约40%）+屹唐（约33.7%）合计超过70%的份额。屹唐的moat=86，是半导体设备链全部21只股票中<strong>最高</strong>的。barrier=5（全球双寡头·认证≥18月），同样是正式物理卡口★★★。但为什么市场上的关注度远不如中微和华海清科？一个可能的原因：去胶设备这个segment，全链只有屹唐一只股票——它是这条赛道上孤独的领跑者。就像一位在独木桥上跑得最快的选手——没人跟他抢道，但也没人关注这条赛道。PE≈174倍极度高估（timing=20），2026Q1营收-10.6%/净利-26.8%（行业周期+高基数+美国实体清单三重叠加），这位「默默无闻的冠军」同样不是一帆风顺。"
        },
        {
          "title": "🎨 光刻配套篇：光刻机的精密机械手",
          "content": "光刻机（ASML独家垄断）是芯片制造里最出名、也最贵的设备——一台EUV光刻机售价高达数亿美元。但光刻机不能单独工作——它需要一个「精密机械手」在光刻之前帮它完成涂胶（把光刻胶均匀涂在晶圆表面）和显影（把曝光后的图案显影出来）。这套设备叫涂胶显影机。<br><br><strong>芯源微</strong>是国内涂胶显影设备的龙头——它的后道涂胶显影设备已经批量供货给台积电、长电、华天等大客户。同时芯源微还有另一条重要的产品线——临时键合/解键合设备（先进封装链的视角），全球仅TEL/EVG/芯源微三家可批量供货。但这里有一个老问题：<strong>两条腿都在走路，但两条腿都在烧钱</strong>——2025年净利-64.6%（恶化幅度与中微相当），营收仅+11%。芯源微的挑战是：涂胶显影的前道高端市场仍被东京电子（TEL）牢牢主导，临时键合设备虽然全球仅三家但芯源微的份额还不到15%（TEL>60%）。「全球仅三家」的稀缺性是真的，「盈利还在恶化」的财务压力也是真的——这两个事实不矛盾。<br><br><strong>福晶科技</strong>是另一个跟光刻工艺相关的公司——它为光刻机的光源系统提供非线性光学晶体（LBO/BBO晶体）。这家公司体量不大但财务健康（moat=73·core），属于「小而美」的细分赛道隐形冠军。它不是光刻机本身，但它是光刻机核心光源部件的重要供应商——就像给劳斯莱斯发动机供火花塞的工厂，虽然小但不可或缺。"
        },
        {
          "title": "🔍 检测+离子注入篇：产业链最后两块拼图",
          "content": "诚实地说：这两个环节在工艺上没有直接关联——一个是芯片出厂前的「全身体检」（检测/测试），一个是改变硅片电学性质的「离子大炮」（离子注入/晶体生长）。把它们放在一段里讲，纯粹是因为它们是半导体设备产业链拼图的最后两块。<br><br><strong>长川科技</strong>是检测段最亮眼的标的：ROE 33.05%、毛利率55.05%、营收+45%、净利+190%——在整个半导体设备链中都是顶尖的财务质量。moat=79·core——不仅壁垒高，而且择时也不错（timing=60）。长川的测试机和分选机覆盖了模拟/数字/混合信号几乎所有芯片类型，国产替代进展迅速。但需要清醒：全球检测设备被KLA（美国·光学检测）、Advantest（日本·测试机）、Teradyne（美国·测试机）三家主导，长川是中国追赶者中跑得最快的那个。与长川同赛道的<strong>精测电子</strong>则没有那么轻松：营收+31%看起来不错，但ROE仅2.23%，净利的高增长（+184%）主要来自极低的基数。<br><br><strong>先导基电</strong>（原万业企业）是国内离子注入机的代表——凯世通（全资子公司）的离子注入设备已经通过中芯国际产线验证，是国内唯一进入头部晶圆厂的国产离子注入机。先导基电的moat=82·core——但ROE为-1.55%、净利-218%，深陷亏损。「国内唯一」的光环与「公司还没赚钱」的现实形成巨大的反差——这是半导体设备行业里最常见的故事：认证已经拿到了、产线已经验证了、订单也在增长——但利润，还在更远的路上。同段的<strong>晶盛机电</strong>则是半导体晶体生长设备（单晶炉）的国内龙头，但2025年营收-35%、净利-65%，moat=56·watch——光伏+半导体双轨受周期压力拖累，半导体这边还在等订单放量。"
        }
      ],
      "chokeTeaser": "读到这里，你可能会问：半导体设备这条产业链里，哪些公司是真正的「关键先生」？五个维度：<strong>中微公司</strong>和<strong>北方华创</strong>代表了「全球仅几家的物理稀缺」（CCP刻蚀全球前三·ICP还在追·净利在烧钱），<strong>华海清科</strong>和<strong>屹唐股份</strong>代表了「不显眼但不可或缺的隐性冠军」（CMP全球仅三家·去胶全球双寡头·但估值都很贵），<strong>拓荆科技</strong>代表了「方向正确但还在烧钱期的成长稀缺」（营收+59%但visibility=2·在读博士阶段）。这一条链的共同特征是：方向都对、壁垒都高、但绝大多数都还没赚钱或利润在恶化——「烧钱换未来」是半导体设备链的核心叙事。具体的卡口深度拆解，请滚动到下方「投资决策」板块查看完整结论。",
      "cycleSignal": "半导体设备行业现在处于什么阶段？用一个比喻：中国正在从零开始建造一套完整的芯片设备工业体系——不是修修补补，是整套体系的重建。大基金三期、02专项、美国出口管制倒逼——三股力量在同时推动。但有两个基本现实需要接受：① <strong>设备国产替代是一个「十年周期」的事</strong>——中微的CCP刻蚀从研发到打入台积电5nm用了超过十年，拓荆的薄膜沉积还在追赶期，不是一两个季报能讲清楚的故事。② <strong>绝大多数设备公司的利润还在恶化或者承压</strong>——中微净利-64.6%、芯源微-64.6%、拓荆visibility=2、华海清科valuation=2——不是因为市场不要它们的设备了，而是因为它们还在「烧钱换未来」的阶段。值得持续观察的具体窗口：中微公司ICP刻蚀的第二增长曲线突破进展、拓荆科技2026H2的净利是否出现盈利拐点、屹唐股份能否摆脱实体清单带来的零部件供应限制、长川科技能否继续保持40%+的营收增速。"
    },
    "chainStory": [
      {
        "step": 1,
  ...
  "fourQuestions": {
    ...
    "industryNote": "半导体设备行业在②产能端、③替代端、④需求端三个维度上，公开数据存在结构性缺失——设备商不按「产能扩张周期」口径披露数据（走的是订单→交付→验收模式，周期取决于客户晶圆厂建设进度）；客户替换供应商的时间和重新认证周期属于商业机密，公开渠道无法获取。因此②③④三列全部标记为 ✗，这不代表标的本身竞争力不足，而是行业信息透明度的客观限制。仅①供给端（全球≤3家）可通过L3机构报告（SEMI/VLSI/Gartner）验证，7只标的（中微/北华创/华海清科/屹唐等）满足该判定。",
    "segments": [
      {
        "name": "CCP/ICP 刻蚀设备",
        ...
        "stocks": [
          {
            ...
            "q2": false,
            "q2note": "半导体设备厂的产能扩张周期与制造业不同——设备商不建厂房扩产，而是按订单→交付→验收的流程走，周期长短取决于客户晶圆厂的建设进度，没有统一的公开口径。因此本题无法从公开渠道获取可验证答案。",
            "q3": false,
            "q3note": "客户（晶圆厂）替换一家已量产的设备供应商需要多长时间，属于商业机密，公开渠道无法获取。这是半导体设备行业的通用信息局限，并非针对本标的。",
            "q4": false,
            "q4note": "需注意区分两个概念：新供应商首次进入产线的导入认证周期（券商研报有覆盖），与从现有供应商切换到新供应商的替换认证周期（商业机密，公开渠道无法获取）。本题要求的是后者，目前无公开数据。",
            "hits": 1,
            "strength": "☆☆☆"
          },
          {
          ...
          },
          {
            ...
            "code": "688082",
            "q1": false,
            "q1note": "该环节的全球竞争者超过3家，或公开的行业格局数据不足以做出精确判断。半导体设备行业的供应商格局数据在公开渠道较为稀缺，这是行业信息透明度的客观限制，并非针对本标的。",
            "q2": false,
            "q2note": "半导体设备厂的产能扩张周期与制造业不同——设备商不建厂房扩产，而是按订单→交付→验收的流程走，周期长短取决于客户晶圆厂的建设进度，没有统一的公开口径。因此本题无法从公开渠道获取可验证答案。",
            "q3": false,
            "q3note": "客户（晶圆厂）替换一家已量产的设备供应商需要多长时间，属于商业机密，公开渠道无法获取。这是半导体设备行业的通用信息局限，并非针对本标的。",
        ...
        "stocks": [
          {
            ...
            "code": "688409",
            "q1": false,
            "q1note": "该环节的全球竞争者超过3家，不满足Q1「全球≤3家」的物理卡口判定标准。精密零部件行业的供应商格局较为分散，不存在单一寡头垄断格局。",
            "q2": false,
            "q2note": "半导体设备厂的产能扩张周期与制造业不同——设备商不建厂房扩产，而是按订单→交付→验收的流程走，周期长短取决于客户晶圆厂的建设进度，没有统一的公开口径。因此本题无法从公开渠道获取可验证答案。",
            "q3": false,
            "q3note": "客户（晶圆厂）替换一家已量产的设备供应商需要多长时间，属于商业机密，公开渠道无法获取。这是半导体设备行业的通用信息局限，并非针对本标的。",
  ...
  "methodologyNotes": "半导体设备产业链采用 Serenity 物理卡口方法论，对 6 大设备段位（刻蚀、薄膜沉积、光刻配套、CMP/清洗、检测、离子注入/晶体生长）的 21 只 A 股标的进行了系统评估。<br><br><strong>卡口认定逻辑</strong>：卡口标的需要满足「全球供给高度集中」这一核心条件。刻蚀段的中微公司（CCP 刻蚀全球前三）、薄膜沉积段的拓荆科技（PECVD/ALD 国内唯一）、CMP 段的华海清科（全球仅三家可量产 12 寸机型）、去胶段的屹唐股份（全球双寡头）——这些标的在各自细分领域有 L3 机构报告（SEMI/VLSI/Gartner）验证的寡头格局数据，构成正式物理卡口。而检测段、离子注入段等环节的供应商格局相对分散，目前尚不满足卡口认定标准——这是行业竞争格局的真实反映，并非数据覆盖不足。<br><br><strong>四问筛选说明</strong>：由于半导体设备行业在产能扩张周期、客户替换时间等维度上的数据存在公开渠道的结构性缺失（详见上方四问筛选板块的行业级说明），本链的四问判定以 ① 供给端（全球 ≤3 家）为主要可验证维度，②③④ 列为行业共性局限。<br><br><strong>六维评分</strong>：每只标的的景气持续性、业绩可见度、政策确定性、供需紧张度、估值性价比、壁垒安全垫六项评分均基于 L1 财报数据与 L3/L4 行业报告独立评估，具体评分依据详见各标的的六维展开面板。",
  "demandChainMeta": {
    "config": {
      "asOf": "2026-07-12",
      "period": "2025-2028",
