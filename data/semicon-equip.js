  ...
  "chokePoints": [
      {
            ...
            "plainLanguageNote": "<strong>💡 大白话：为什么屹唐股份是物理卡口？</strong><br><br>芯片制造有一道叫\"去胶\"的工序——听起来像修车，实际上是纳米级的精密手术。光刻胶涂在晶圆上之后，刻完电路就得把它干干净净地去掉，不能留任何残渣。去胶设备这个赛道，全球只有两家公司占了超过70%的份额：韩国的PSK和中国的屹唐股份（第三名Lam Research的份额不到10%）。等于说这是一个\"二人转\"市场——全球第二把第三名甩出了几条街。屹唐是A股唯一的去胶设备标的，虽然市值不大，但在\"去胶\"这个小赛道上它是绝对的王者。这就是\"我不是最大的公司，但全世界能跟你PK的只有一个人\"的物理卡口。"
      },
      {
            "rank": 2,
            "name": "中微公司",
            ...
            "strengthNote": "2026-07-12 全站一致性排查补strengthNote:fourQuestions hits=1(q1=true) 而非 hits=4 是因为半导体设备行业Q2/Q3/Q4系统性数据不可得(§11.23已论证:设备厂扩产周期无公开口径/客户替换认证属商业机密/L4研报只覆盖导入认证≠替换认证)·barrier=5(极高)有L3+L4双源强支撑(SEMI/VLSI Gartner全球设备厂商格局报告 + 头部券商认证周期专题研报):全球仅3家可量产先进制程CCP刻蚀设备(AMAT/Lam/中微)·认证壁垒≥18月·中微5nm已批量供货台积电N3P·strength=★★★依据barrier物理卡口地位而非四问命中率·参照华海清科688120同模式处置",
            "plainLanguageNote": "<strong>💡 大白话：为什么中微公司是物理卡口？</strong><br><br>刻蚀是芯片制造最核心的工序之一——把不需要的材料用等离子体精准地\"烧\"掉，留下精密的电路图案。中微做的是CCP刻蚀机（电容耦合等离子体），专门刻深孔和深槽——3D NAND闪存的几百层堆叠，每层都要刻出垂直的孔道来连通。中微的5nm刻蚀机已经打进了台积电的生产线——这相当于中国厨师做了一道法国大厨认可的法餐，意义非同小可。但中微离\"全球寡头\"还有距离：泛林半导体（Lam Research）占据全球刻蚀机约一半份额。中微是国产替代最确定的设备标的之一——卡口成立，但还不是独占性的。"
      },
      {
            "rank": 3,
            "name": "北方华创",
            ...
            "strengthNote": "2026-07-12 全站一致性排查补strengthNote:fourQuestions hits=1(q1=true) 而非 hits=4 是因为半导体设备行业Q2/Q3/Q4系统性数据不可得(§11.23已论证:设备厂扩产周期无公开口径/客户替换认证属商业机密/L4研报只覆盖导入认证≠替换认证)·barrier=5(极高)有L3+L4双源强支撑(SEMI/VLSI Gartner全球综合半导体设备厂商竞争格局报告 + 头部券商认证周期专题研报):全球仅≤3家可同时量产ICP/CCP刻蚀+PVD/CVD薄膜沉积+湿法清洗全品类先进制程半导体设备·单类认证≥18月·多品类叠加认证周期+工艺know-how+客户产线适配转换成本极高·北方华创14nm CCP已通过中芯国际验证·28nm多产品线批量·strength=★★★依据barrier物理卡口地位而非四问命中率·参照华海清科688120同模式处置",
            "plainLanguageNote": "<strong>💡 大白话：为什么北方华创是物理卡口？</strong><br><br>如果把半导体设备比作一个超大型工具箱——光刻机、刻蚀机、薄膜沉积、清洗、热处理……每种设备都是不同的工具。全球绝大多数设备公司只擅长一种工具（比如中微专注刻蚀），但北方华创是A股唯一一家什么工具都做的\"平台型\"公司：几十种设备覆盖了芯片制造的大部分工序。这个定位就像\"全科医院\"——单独每个科室可能不是全国第一，但没有其他医院能让你在一个地方看完所有科室。全球能做到这个级别的只有美国的应用材料（AMAT）和泛林（Lam），北方华创是国内唯一的平台型设备公司。客户一旦选择了北方华创的多设备方案，切换成本就从\"换一个\"变成了\"换几十个\"。"
      },
      {
            "rank": 4,
            "name": "华海清科",
            ...
            "plainLanguageNote": "<strong>💡 大白话：为什么华海清科是物理卡口？</strong><br><br>CMP化学机械抛光设备，你可以把它想象成芯片制造过程中的\"打磨机\"——每一层电路做好之后，都要用这个设备把表面磨得像镜面一样平整，误差不超过几纳米。全球12英寸CMP设备只有三家公司能量产：美国的应用材料（AMAT）、日本的荏原（Ebara）、中国的华海清科。华海清科已经批量进入了中芯国际和长江存储的生产线——这相当于国产\"高铁打磨车\"开进了国家最高标准的铁轨上干活。但有一个需要关注的变化：华海清科的净利增速从2024年超过40%大幅降到了2025年的个位数增长，说明高增长阶段可能正在进入平台期。卡口的逻辑是\"全球只有三家，你是其中一家\"——但这个卡口需要业绩持续验证。"
      },
      {
            "rank": 5,
            "name": "拓荆科技",
            ...
            "plainLanguageNote": "<strong>💡 大白话：为什么拓荆科技是物理卡口？</strong><br><br>薄膜沉积就是\"给芯片盖被子\"——一层一层地往上镀出极薄的绝缘层和导电层。拓荆科技是国内薄膜沉积设备的龙头，特别是PECVD和ALD这两种最先进的工艺。半导体设备行业有个奇特的特点：业绩像心电图一样大起大落——拓荆2025年第一季度单季亏损，但Q2就扭亏了，到2026年Q1一个季度的净利润就超过了2024全年。这种\"心电图式\"的走势让很多投资者望而却步，但恰恰是设备行业的常态：一台设备从下单到验收可能要12-18个月，中间全是投入没有收入。拓荆的卡口逻辑是\"国产第一\"，但全球来看还有AMAT和Lam两个巨无霸挡在前面——你做成了国内老大，但全球登山的路还很长。"
      }
],
  "supplyGap": [
    {
